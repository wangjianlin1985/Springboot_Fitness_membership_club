/*
 ...
 Source Schema         : gp_gym

 Target Server Type    : MySQL
 Target Server Version : 50620
 File Encoding         : 65001

 Date: 04/09/2022 22:16:42
*/
...
-- ----------------------------
INSERT INTO `bbs_reply` VALUES (1, '2022-10-25 10:00:00', '回复的内容111', 1, 1);
INSERT INTO `bbs_reply` VALUES (2, '2022-10-30 12:58:10', '的观点', 1, 1);
INSERT INTO `bbs_reply` VALUES (3, '2022-10-30 15:11:59', '实现', 1, 3);
INSERT INTO `bbs_reply` VALUES (4, '2022-10-31 13:18:20', '啊顶顶顶', 1, 3);
...
-- ----------------------------
INSERT INTO `bbs_section` VALUES (1, '板块1', 101, 1);
INSERT INTO `bbs_section` VALUES (2, '板块2', 2, 1);
...
CREATE TABLE `bbs_topic`  (
  ...
  `time` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `numSee` int(11) NULL DEFAULT 0,
  `numReply` int(11) NULL DEFAULT 0,
  `content` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL,
  `user_id` bigint(20) NULL DEFAULT NULL,
...
-- ----------------------------
INSERT INTO `bbs_topic` VALUES (1, '第一篇帖子', '2022-10-30 10:40:0', 21, 4, '帖子的内容士大夫精神的海景房宽松的环境', 1, '管理员', 1);
INSERT INTO `bbs_topic` VALUES (3, '32423423', '2022-10-30 14:27:27', 9, 2, '234234234', 1, '超级管理员', 1);
INSERT INTO `bbs_topic` VALUES (4, 'sdasd', '2022-10-31 01:16:54', 2, 0, 'asdasdas', 12711, '会员', 1);
INSERT INTO `bbs_topic` VALUES (5, '一起锻炼身体的有吗', '2022-09-04 21:09:45', 1, 0, '有没有一起锻炼身体的，约下', 12711, '会员', 2);
...
-- ----------------------------
INSERT INTO `club_card` VALUES (2, 'werwerw', 32, 0, '2022-10-26', '2023-11-02', 4, 12711);
INSERT INTO `club_card` VALUES (3, '11341444', 20, 0, '2022-09-04', '2022-11-04', 3, 12713);

-- ----------------------------
-- Table structure for club_detail
-- ----------------------------
...
CREATE TABLE `club_detail`  (
  ...
  `coach_id` bigint(20) NULL DEFAULT NULL,
  `money` int(11) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 6 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = Compact;

-- ----------------------------
-- Records of club_detail
-- ----------------------------
INSERT INTO `club_detail` VALUES (2, 3, 4, '2022-10-31 00:00:00', '2022-10-31 01:00:00', 1, 12712, 22);
INSERT INTO `club_detail` VALUES (3, 5, 4, '2022-08-04 00:00:00', '2022-09-29 00:00:00', 1, 12712, 30);
INSERT INTO `club_detail` VALUES (4, 4, 5, '2022-07-13 00:00:00', '2022-09-30 00:00:00', 2, 12714, 100);
INSERT INTO `club_detail` VALUES (5, 4, 4, '2021-07-06 00:00:00', '2022-09-30 00:00:00', 1, 12712, 200);

-- ----------------------------
-- Table structure for club_level
-- ----------------------------
...
-- ----------------------------
-- Records of club_level
-- ----------------------------
INSERT INTO `club_level` VALUES (1, '等级1', 100, 0, 1000);
INSERT INTO `club_level` VALUES (2, '等级2', 90, 1001, 2000);

-- ----------------------------
-- Table structure for club_machine
-- ----------------------------
...
-- ----------------------------
-- Records of club_machine
-- ----------------------------
INSERT INTO `club_machine` VALUES (1, '跑步机', 40);
INSERT INTO `club_machine` VALUES (2, '健腹器', 10);
INSERT INTO `club_machine` VALUES (3, '杠铃', 18);

-- ----------------------------
-- Table structure for club_machineio
-- ----------------------------
...
CREATE TABLE `club_machineio`  (
  ...
  `io` tinyint(4) NULL DEFAULT NULL,
  `machine_id` bigint(20) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 6 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = Compact;

-- ----------------------------
-- Records of club_machineio
-- ----------------------------
INSERT INTO `club_machineio` VALUES (1, 50, '2022-10-27 22:18:43', NULL, 0, 1);
INSERT INTO `club_machineio` VALUES (2, 10, '2022-10-27 22:19:40', '报废销毁', 1, 1);
INSERT INTO `club_machineio` VALUES (3, 10, '2022-09-04 21:23:17', '采购入库', 0, 2);
INSERT INTO `club_machineio` VALUES (4, 20, '2022-09-04 21:23:30', '采购入库', 0, 3);
INSERT INTO `club_machineio` VALUES (5, 2, '2022-09-04 21:23:51', '报废销毁', 1, 3);

-- ----------------------------
-- Table structure for club_project
-- ----------------------------
...
CREATE TABLE `club_project`  (
  ...
  `name` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `money` int(11) NULL DEFAULT NULL,
  `disease` varchar(512) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 7 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = Compact;

-- ----------------------------
-- Records of club_project
-- ----------------------------
INSERT INTO `club_project` VALUES (4, '跑步', 20, '高血压,脚踝,膝盖');
INSERT INTO `club_project` VALUES (5, '仰卧起坐', 20, '呼吸系统');
INSERT INTO `club_project` VALUES (6, '游泳', 10, '心脏病,呼吸系统');
...
-- ----------------------------
-- Records of club_record
-- ----------------------------
INSERT INTO `club_record` VALUES (3, 12711, '2022-10-31 00:00:00', '2022-10-31 00:00:00', 22, '21333', 1);
INSERT INTO `club_record` VALUES (4, 12713, '2022-10-31 00:00:00', '2022-11-01 00:00:00', 300, '手动阀手动阀', 0);
INSERT INTO `club_record` VALUES (5, 12711, '2022-08-11 00:00:00', '2022-09-29 00:00:00', 30, '练习腹肌', 1);

-- ----------------------------
-- Table structure for club_user_level
-- ----------------------------
...
-- ----------------------------
-- Records of club_user_level
-- ----------------------------
INSERT INTO `club_user_level` VALUES (1, 1, 12711);
...
) ENGINE = InnoDB AUTO_INCREMENT = 123 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '参数配置表' ROW_FORMAT = Compact;
...
INSERT INTO `sys_config` VALUES (101, '系统名称', 'sys.name', '健身俱乐部', 'Y', 'admin', '2019-08-07 00:04:04', 'admin', '2022-10-30 15:10:00', '由“项目配置”页面更改操作', 0, NULL, NULL);
INSERT INTO `sys_config` VALUES (102, '系统版权', 'sys.copyright', '© 2022 All Rights Reserved. CLUB', 'Y', 'admin', '2019-08-07 00:26:47', 'admin', '2022-10-31 12:09:17', '由“项目配置”页面更改操作', 0, NULL, NULL);
INSERT INTO `sys_config` VALUES (103, 'LOGO图片', 'sys.logo', '/profile/logo/2022/09/04/fd34b68ece895443e42c57db12d4657a.jpg', 'Y', 'admin', '2019-08-08 00:03:03', 'admin', '2022-09-04 21:07:21', '由“项目配置”页面更改操作', 0, NULL, NULL);
INSERT INTO `sys_config` VALUES (111, '学校部门根部门ID', 'schoole_dept_root_id', '101', 'Y', 'admin', '2019-12-04 10:00:08', '', NULL, NULL, 1, '2022-04-12 21:41:43', 'admin');
INSERT INTO `sys_config` VALUES (117, '学校名称', 'sys.school.name', '合肥市经贸旅游学校', 'Y', '', NULL, '', NULL, NULL, 1, '2022-04-12 21:41:43', 'admin');
INSERT INTO `sys_config` VALUES (118, '建设单位根目录ID', 'js_root_dept_id', '102', 'Y', 'admin', '2022-04-12 21:42:43', '', NULL, NULL, 1, '2022-10-27 22:24:17', 'admin');
INSERT INTO `sys_config` VALUES (119, '承建单位根目录ID', 'cj_root_dept_id', '101', 'Y', 'admin', '2022-04-12 21:43:14', '', NULL, NULL, 1, '2022-10-27 22:24:17', 'admin');
INSERT INTO `sys_config` VALUES (120, '监理单位根目录ID', 'jl_root_dept_id', '202', 'Y', 'admin', '2022-04-12 21:43:44', '', NULL, NULL, 1, '2022-10-27 22:24:17', 'admin');
INSERT INTO `sys_config` VALUES (121, '生日提醒提前天数', 'birth_remind_day', '7', 'Y', 'admin', '2022-10-31 12:08:44', 'admin', '2022-10-31 12:08:55', '提前多少天生日提醒', 0, NULL, NULL);
INSERT INTO `sys_config` VALUES (122, '会员余额提醒', 'money_remind', '300', 'Y', 'admin', '2022-10-31 12:10:10', '', NULL, '会员卡余额少于多少进行提醒', 0, NULL, NULL);
...
) ENGINE = InnoDB AUTO_INCREMENT = 218 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '部门表' ROW_FORMAT = Compact;

-- ----------------------------
-- Records of sys_dept
-- ----------------------------
INSERT INTO `sys_dept` VALUES (100, 0, '0', '健身俱乐部', 0, '', '', '', NULL, '0', 0, 'admin', '2018-03-16 11:33:00', 'admin', '2022-10-24 11:53:23', NULL, NULL);
INSERT INTO `sys_dept` VALUES (101, 100, '0,100', '后勤部', 3, '', '', '', '后勤部', '0', 0, 'admin', '2018-03-16 11:33:00', 'admin', '2022-10-24 11:52:53', NULL, NULL);
INSERT INTO `sys_dept` VALUES (213, 100, '0,100', '会员部', 20, '', '', '', '会员部', '0', 0, 'admin', '2022-10-24 11:53:07', 'admin', '2022-10-24 11:53:23', NULL, NULL);
INSERT INTO `sys_dept` VALUES (214, 100, '0,100', '训练部', 20, NULL, NULL, NULL, '训练部', '0', 0, 'admin', '2022-10-24 11:53:34', '', NULL, NULL, NULL);
INSERT INTO `sys_dept` VALUES (215, 100, '0,100', '设备管理部', 30, NULL, NULL, NULL, '设备管理部', '0', 0, 'admin', '2022-10-24 11:54:00', '', NULL, NULL, NULL);
INSERT INTO `sys_dept` VALUES (216, 100, '0,100', '会员', 0, NULL, NULL, NULL, '会员', '0', 0, 'admin', '2022-10-24 14:20:37', '', NULL, NULL, NULL);
INSERT INTO `sys_dept` VALUES (217, 100, '0,100', '教练部', 100, NULL, NULL, NULL, '教练部', '0', 0, 'admin', '2022-10-29 22:30:47', '', NULL, NULL, NULL);
...
) ENGINE = InnoDB AUTO_INCREMENT = 130 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '字典数据表' ROW_FORMAT = Compact;
...
INSERT INTO `sys_dict_data` VALUES (14, 1, '通知', '1', 'sys_notice_type', '', 'warning', 'Y', '0', 'admin', '2018-03-16 11:33:00', 'admin', '2018-03-16 11:33:00', '通知', 1, 'admin', '2022-04-12 21:45:32');
INSERT INTO `sys_dict_data` VALUES (15, 2, '公告', '2', 'sys_notice_type', '', 'success', 'N', '0', 'admin', '2018-03-16 11:33:00', 'admin', '2018-03-16 11:33:00', '公告', 1, 'admin', '2022-04-12 21:45:32');
INSERT INTO `sys_dict_data` VALUES (16, 1, '正常', '0', 'sys_notice_status', '', 'primary', 'Y', '0', 'admin', '2018-03-16 11:33:00', 'admin', '2018-03-16 11:33:00', '正常状态', 1, 'admin', '2022-04-12 21:45:38');
INSERT INTO `sys_dict_data` VALUES (17, 2, '关闭', '1', 'sys_notice_status', '', 'danger', 'N', '0', 'admin', '2018-03-16 11:33:00', 'admin', '2018-03-16 11:33:00', '关闭状态', 1, 'admin', '2022-04-12 21:45:38');
...
INSERT INTO `sys_dict_data` VALUES (103, 2, '是', '1', 'article_need_audit_status', '', 'default', 'N', '0', 'admin', '2019-08-15 22:53:39', 'admin', '2019-08-15 22:54:12', '需要审核', 1, 'admin', '2022-04-12 21:45:11');
INSERT INTO `sys_dict_data` VALUES (104, 3, '否', '0', 'article_need_audit_status', '', 'default', 'Y', '0', 'admin', '2019-08-15 22:53:55', 'admin', '2019-08-15 22:54:06', '不需要审核', 1, 'admin', '2022-04-12 21:45:11');
INSERT INTO `sys_dict_data` VALUES (105, 2, '否', '0', 'article_istop', NULL, NULL, 'Y', '0', 'admin', '2019-08-17 15:57:50', 'admin', NULL, '不置顶', 1, 'admin', '2022-04-12 21:44:54');
INSERT INTO `sys_dict_data` VALUES (106, 0, '是', '1', 'article_istop', NULL, NULL, 'N', '0', 'admin', '2019-08-17 15:58:07', 'admin', NULL, '置顶', 1, 'admin', '2022-04-12 21:44:54');
...
INSERT INTO `sys_dict_data` VALUES (117, 3, '需要', '1', 'article_need_read', NULL, NULL, 'Y', '0', 'admin', '2020-11-30 16:19:15', '', NULL, NULL, 1, 'admin', '2022-04-12 21:45:19');
INSERT INTO `sys_dict_data` VALUES (118, 2, '不需要', '2', 'article_need_read', '', '', 'N', '0', 'admin', '2020-11-30 16:19:26', 'admin', '2020-11-30 16:23:54', '', 1, 'admin', '2022-04-12 21:45:19');
INSERT INTO `sys_dict_data` VALUES (119, 100, '非密', '非密', 'security_classification', NULL, 'default', 'Y', '0', 'admin', '2022-04-13 22:22:30', '', NULL, NULL, 0, NULL, NULL);
INSERT INTO `sys_dict_data` VALUES (120, 90, '加密', '加密', 'security_classification', NULL, 'default', 'Y', '0', 'admin', '2022-04-13 22:22:43', '', NULL, NULL, 0, NULL, NULL);
INSERT INTO `sys_dict_data` VALUES (121, 80, '绝密', '绝密', 'security_classification', NULL, 'default', 'Y', '0', 'admin', '2022-04-13 22:23:00', '', NULL, NULL, 0, NULL, NULL);
INSERT INTO `sys_dict_data` VALUES (122, 100, '采购入库', '采购入库', 'iotype', NULL, NULL, 'Y', '0', 'admin', '2022-10-27 22:12:21', '', NULL, NULL, 0, NULL, NULL);
INSERT INTO `sys_dict_data` VALUES (123, 90, '报废销毁', '报废销毁', 'iotype', NULL, NULL, 'Y', '0', 'admin', '2022-10-27 22:12:40', '', NULL, NULL, 0, NULL, NULL);
INSERT INTO `sys_dict_data` VALUES (124, 90, '心脏病', '心脏病', 'diseaseList', NULL, NULL, 'Y', '0', 'admin', '2022-10-27 22:20:57', '', NULL, NULL, 0, NULL, NULL);
INSERT INTO `sys_dict_data` VALUES (125, 80, '高血压', '高血压', 'diseaseList', NULL, NULL, 'Y', '0', 'admin', '2022-10-27 22:21:06', '', NULL, NULL, 0, NULL, NULL);
INSERT INTO `sys_dict_data` VALUES (126, 80, '呼吸系统', '呼吸系统', 'diseaseList', NULL, NULL, 'Y', '0', 'admin', '2022-10-27 22:21:27', '', NULL, NULL, 0, NULL, NULL);
INSERT INTO `sys_dict_data` VALUES (127, 70, '肝肾系统', '肝肾系统', 'diseaseList', NULL, NULL, 'Y', '0', 'admin', '2022-10-27 22:21:38', '', NULL, NULL, 0, NULL, NULL);
INSERT INTO `sys_dict_data` VALUES (128, 60, '脚踝', '脚踝', 'diseaseList', NULL, NULL, 'Y', '0', 'admin', '2022-10-27 22:21:49', '', NULL, NULL, 0, NULL, NULL);
INSERT INTO `sys_dict_data` VALUES (129, 60, '膝盖', '膝盖', 'diseaseList', NULL, NULL, 'Y', '0', 'admin', '2022-10-27 22:22:00', '', NULL, NULL, 0, NULL, NULL);
...
) ENGINE = InnoDB AUTO_INCREMENT = 109 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '字典类型表' ROW_FORMAT = Compact;
...
INSERT INTO `sys_dict_type` VALUES (7, '通知类型', 'sys_notice_type', '0', 40, 'admin', '2018-03-16 11:33:00', 'demo', '2018-03-16 11:33:00', '通知类型列表', 'admin', 1, '2022-04-12 21:45:56');
INSERT INTO `sys_dict_type` VALUES (8, '通知状态', 'sys_notice_status', '0', 30, 'admin', '2018-03-16 11:33:00', 'demo', '2018-03-16 11:33:00', '通知状态列表', 'admin', 1, '2022-04-12 21:45:56');
...
INSERT INTO `sys_dict_type` VALUES (100, '文章审核状态', 'article_need_audit_status', '0', 110, 'admin', '2019-08-15 22:52:49', 'demo', '2019-08-22 10:29:34', '文章审核状态列表', 'admin', 1, '2022-04-12 21:45:24');
INSERT INTO `sys_dict_type` VALUES (101, '文章置顶', 'article_istop', '0', 120, 'admin', '2019-08-17 15:57:02', 'admin', '2020-03-17 10:06:22', '文章是否置顶', 'admin', 1, '2022-04-12 21:45:06');
...
INSERT INTO `sys_dict_type` VALUES (105, '文章反馈', 'article_need_read', '0', 109, 'admin', '2020-11-30 16:17:44', 'admin', '2020-11-30 16:18:27', '', 'admin', 1, '2022-04-12 21:45:24');
INSERT INTO `sys_dict_type` VALUES (106, '文档密级', 'security_classification', '0', 140, 'admin', '2022-04-13 22:21:42', '', NULL, NULL, NULL, 0, NULL);
INSERT INTO `sys_dict_type` VALUES (107, '器械进出类型', 'iotype', '0', 1000, 'admin', '2022-10-27 22:12:03', '', NULL, NULL, NULL, 0, NULL);
INSERT INTO `sys_dict_type` VALUES (108, '运动疾病', 'diseaseList', '0', 900, 'admin', '2022-10-27 22:20:43', '', NULL, NULL, NULL, 0, NULL);
...
) ENGINE = MyISAM AUTO_INCREMENT = 1937 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '系统访问记录' ROW_FORMAT = Dynamic;
...
INSERT INTO `sys_logininfor` VALUES (1584, 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '登录成功', '2022-01-12 14:39:46');
INSERT INTO `sys_logininfor` VALUES (1585, 'admin', '112.26.168.227', '未知', 'Chrome 8', 'Windows 10', '0', '登录成功', '2022-01-12 14:48:56');
INSERT INTO `sys_logininfor` VALUES (1586, 'admin', '223.104.37.171', '未知', 'Chrome Mobile', 'Android 1.x', '0', '登录成功', '2022-01-12 14:49:33');
INSERT INTO `sys_logininfor` VALUES (1587, 'admin', '112.26.168.227', '未知', 'Chrome 8', 'Windows 10', '0', '登录成功', '2022-01-12 14:52:54');
INSERT INTO `sys_logininfor` VALUES (1588, 'admin', '223.104.37.171', '未知', 'Chrome Mobile', 'Android 1.x', '1', '密码输入错误1次', '2022-01-12 14:55:05');
INSERT INTO `sys_logininfor` VALUES (1589, 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '登录成功', '2022-02-04 09:53:09');
INSERT INTO `sys_logininfor` VALUES (1590, 'admin', '127.0.0.1', '内网IP', 'Chrome', 'Windows 10', '1', '密码输入错误1次', '2022-04-12 16:44:40');
INSERT INTO `sys_logininfor` VALUES (1591, 'admin', '127.0.0.1', '内网IP', 'Chrome', 'Windows 10', '0', '登录成功', '2022-04-12 16:44:45');
INSERT INTO `sys_logininfor` VALUES (1592, 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Mac OS X', '0', '登录成功', '2022-04-12 21:34:17');
INSERT INTO `sys_logininfor` VALUES (1593, 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Mac OS X', '0', '登录成功', '2022-04-12 22:14:54');
INSERT INTO `sys_logininfor` VALUES (1594, 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '1', '密码输入错误1次', '2022-04-13 20:40:06');
INSERT INTO `sys_logininfor` VALUES (1595, 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '1', '密码输入错误2次', '2022-04-13 20:40:10');
INSERT INTO `sys_logininfor` VALUES (1596, 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '登录成功', '2022-04-13 20:40:15');
INSERT INTO `sys_logininfor` VALUES (1597, 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '登录成功', '2022-04-13 21:03:56');
INSERT INTO `sys_logininfor` VALUES (1598, 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '登录成功', '2022-04-13 21:12:52');
INSERT INTO `sys_logininfor` VALUES (1599, 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '退出成功', '2022-04-13 21:13:35');
INSERT INTO `sys_logininfor` VALUES (1600, 'js1', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '1', '密码输入错误1次', '2022-04-13 21:13:40');
INSERT INTO `sys_logininfor` VALUES (1601, 'js1', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '登录成功', '2022-04-13 21:13:44');
INSERT INTO `sys_logininfor` VALUES (1602, 'js1', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '登录成功', '2022-04-13 21:24:50');
INSERT INTO `sys_logininfor` VALUES (1603, 'js1', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '登录成功', '2022-04-13 21:28:56');
INSERT INTO `sys_logininfor` VALUES (1604, 'js1', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '登录成功', '2022-04-13 21:34:17');
INSERT INTO `sys_logininfor` VALUES (1605, 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '1', '密码输入错误1次', '2022-04-13 21:36:37');
INSERT INTO `sys_logininfor` VALUES (1606, 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '登录成功', '2022-04-13 21:36:41');
INSERT INTO `sys_logininfor` VALUES (1607, 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '退出成功', '2022-04-13 21:43:28');
INSERT INTO `sys_logininfor` VALUES (1608, 'js12', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '登录成功', '2022-04-13 21:43:34');
INSERT INTO `sys_logininfor` VALUES (1609, 'js12', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '退出成功', '2022-04-13 21:43:54');
INSERT INTO `sys_logininfor` VALUES (1610, 'js11', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '1', '密码输入错误1次', '2022-04-13 21:43:59');
INSERT INTO `sys_logininfor` VALUES (1611, 'js11', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '1', '密码输入错误2次', '2022-04-13 21:44:02');
INSERT INTO `sys_logininfor` VALUES (1612, 'js11', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '1', '密码输入错误3次', '2022-04-13 21:44:07');
INSERT INTO `sys_logininfor` VALUES (1613, 'js11', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '1', '密码输入错误4次', '2022-04-13 21:44:11');
INSERT INTO `sys_logininfor` VALUES (1614, 'js11', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '1', '密码输入错误5次', '2022-04-13 21:45:06');
INSERT INTO `sys_logininfor` VALUES (1615, 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '1', '密码输入错误1次', '2022-04-13 21:45:31');
INSERT INTO `sys_logininfor` VALUES (1616, 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '登录成功', '2022-04-13 21:45:37');
INSERT INTO `sys_logininfor` VALUES (1617, 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '退出成功', '2022-04-13 21:45:54');
INSERT INTO `sys_logininfor` VALUES (1618, 'js11', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '1', '密码输入错误5次，帐户锁定10分钟', '2022-04-13 21:46:00');
INSERT INTO `sys_logininfor` VALUES (1619, 'js12', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '登录成功', '2022-04-13 21:51:37');
INSERT INTO `sys_logininfor` VALUES (1620, 'js11', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '登录成功', '2022-04-13 21:53:02');
INSERT INTO `sys_logininfor` VALUES (1621, 'js11', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '登录成功', '2022-04-13 21:54:52');
INSERT INTO `sys_logininfor` VALUES (1622, 'js11', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '退出成功', '2022-04-13 21:59:57');
INSERT INTO `sys_logininfor` VALUES (1623, 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '1', '密码输入错误1次', '2022-04-13 22:00:02');
INSERT INTO `sys_logininfor` VALUES (1624, 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '1', '密码输入错误2次', '2022-04-13 22:00:10');
INSERT INTO `sys_logininfor` VALUES (1625, 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '登录成功', '2022-04-13 22:00:13');
INSERT INTO `sys_logininfor` VALUES (1626, 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '退出成功', '2022-04-13 22:00:34');
INSERT INTO `sys_logininfor` VALUES (1627, 'js11', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '登录成功', '2022-04-13 22:02:17');
INSERT INTO `sys_logininfor` VALUES (1628, 'js11', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '登录成功', '2022-04-13 22:07:15');
INSERT INTO `sys_logininfor` VALUES (1629, 'js11', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '登录成功', '2022-04-13 22:09:32');
INSERT INTO `sys_logininfor` VALUES (1630, 'js11', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '退出成功', '2022-04-13 22:10:15');
INSERT INTO `sys_logininfor` VALUES (1631, 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '1', '密码输入错误1次', '2022-04-13 22:19:49');
INSERT INTO `sys_logininfor` VALUES (1632, 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '登录成功', '2022-04-13 22:19:52');
INSERT INTO `sys_logininfor` VALUES (1633, 'js11', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '登录成功', '2022-04-14 09:39:46');
INSERT INTO `sys_logininfor` VALUES (1634, 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '登录成功', '2022-04-14 14:11:11');
INSERT INTO `sys_logininfor` VALUES (1635, 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '退出成功', '2022-04-14 14:13:44');
INSERT INTO `sys_logininfor` VALUES (1636, 'jl11', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '1', '密码输入错误1次', '2022-04-14 14:15:13');
INSERT INTO `sys_logininfor` VALUES (1637, 'jl11', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '1', '密码输入错误2次', '2022-04-14 14:15:18');
INSERT INTO `sys_logininfor` VALUES (1638, 'jl11', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '1', '密码输入错误3次', '2022-04-14 14:16:05');
INSERT INTO `sys_logininfor` VALUES (1639, 'jl11', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '1', '密码输入错误4次', '2022-04-14 14:16:11');
INSERT INTO `sys_logininfor` VALUES (1640, 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '登录成功', '2022-04-14 14:16:19');
INSERT INTO `sys_logininfor` VALUES (1641, 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '退出成功', '2022-04-14 14:16:40');
INSERT INTO `sys_logininfor` VALUES (1642, 'jl11', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '登录成功', '2022-04-14 14:16:47');
INSERT INTO `sys_logininfor` VALUES (1643, 'jl11', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '登录成功', '2022-04-14 14:20:45');
INSERT INTO `sys_logininfor` VALUES (1644, 'jl11', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '1', '密码输入错误1次', '2022-04-14 14:24:27');
INSERT INTO `sys_logininfor` VALUES (1645, 'jl11', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '登录成功', '2022-04-14 14:24:31');
INSERT INTO `sys_logininfor` VALUES (1646, 'jl11', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '1', '密码输入错误1次', '2022-04-14 14:29:19');
INSERT INTO `sys_logininfor` VALUES (1647, 'jl11', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '登录成功', '2022-04-14 14:29:24');
INSERT INTO `sys_logininfor` VALUES (1648, 'jl11', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '登录成功', '2022-04-14 14:32:33');
INSERT INTO `sys_logininfor` VALUES (1649, 'jl11', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '1', '密码输入错误1次', '2022-04-14 14:35:50');
INSERT INTO `sys_logininfor` VALUES (1650, 'jl11', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '登录成功', '2022-04-14 14:35:54');
INSERT INTO `sys_logininfor` VALUES (1651, 'jl11', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '1', '密码输入错误1次', '2022-04-14 15:15:14');
INSERT INTO `sys_logininfor` VALUES (1652, 'jl11', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '1', '密码输入错误2次', '2022-04-14 15:15:18');
INSERT INTO `sys_logininfor` VALUES (1653, 'jl11', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '登录成功', '2022-04-14 15:15:21');
INSERT INTO `sys_logininfor` VALUES (1654, 'jl11', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '登录成功', '2022-04-14 15:22:23');
INSERT INTO `sys_logininfor` VALUES (1655, 'jl11', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '登录成功', '2022-04-14 15:32:17');
INSERT INTO `sys_logininfor` VALUES (1656, 'jl11', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '1', '密码输入错误1次', '2022-04-14 15:58:49');
INSERT INTO `sys_logininfor` VALUES (1657, 'jl11', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '登录成功', '2022-04-14 15:58:55');
INSERT INTO `sys_logininfor` VALUES (1658, 'jl11', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '退出成功', '2022-04-14 16:15:22');
INSERT INTO `sys_logininfor` VALUES (1659, 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '登录成功', '2022-04-14 16:15:28');
INSERT INTO `sys_logininfor` VALUES (1660, 'jl11', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '登录成功', '2022-04-14 16:35:06');
INSERT INTO `sys_logininfor` VALUES (1661, 'jl11', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '退出成功', '2022-04-14 16:38:53');
INSERT INTO `sys_logininfor` VALUES (1662, 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '1', '密码输入错误1次', '2022-04-14 16:38:56');
INSERT INTO `sys_logininfor` VALUES (1663, 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '登录成功', '2022-04-14 16:39:27');
INSERT INTO `sys_logininfor` VALUES (1664, 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '退出成功', '2022-04-14 16:40:51');
INSERT INTO `sys_logininfor` VALUES (1665, 'jl12', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '登录成功', '2022-04-14 16:41:19');
INSERT INTO `sys_logininfor` VALUES (1666, 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Mac OS X', '0', '登录成功', '2022-04-14 21:11:45');
INSERT INTO `sys_logininfor` VALUES (1667, 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Mac OS X', '0', '登录成功', '2022-04-14 22:41:19');
INSERT INTO `sys_logininfor` VALUES (1668, 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Mac OS X', '0', '退出成功', '2022-04-14 22:46:36');
INSERT INTO `sys_logininfor` VALUES (1669, 'jl11', '127.0.0.1', '内网IP', 'Chrome 8', 'Mac OS X', '0', '登录成功', '2022-04-14 22:46:42');
INSERT INTO `sys_logininfor` VALUES (1670, 'jl11', '127.0.0.1', '内网IP', 'Chrome 8', 'Mac OS X', '0', '退出成功', '2022-04-14 22:46:49');
INSERT INTO `sys_logininfor` VALUES (1671, 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Mac OS X', '0', '登录成功', '2022-04-14 22:46:55');
INSERT INTO `sys_logininfor` VALUES (1672, 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Mac OS X', '0', '退出成功', '2022-04-14 22:47:15');
INSERT INTO `sys_logininfor` VALUES (1673, 'jl11', '127.0.0.1', '内网IP', 'Chrome 8', 'Mac OS X', '0', '登录成功', '2022-04-14 22:47:22');
INSERT INTO `sys_logininfor` VALUES (1674, 'jl11', '127.0.0.1', '内网IP', 'Chrome 8', 'Mac OS X', '0', '登录成功', '2022-04-14 22:51:19');
INSERT INTO `sys_logininfor` VALUES (1675, 'jl11', '127.0.0.1', '内网IP', 'Chrome 8', 'Mac OS X', '0', '登录成功', '2022-04-14 23:05:07');
INSERT INTO `sys_logininfor` VALUES (1676, 'jl11', '127.0.0.1', '内网IP', 'Chrome 8', 'Mac OS X', '0', '登录成功', '2022-04-14 23:12:46');
INSERT INTO `sys_logininfor` VALUES (1677, 'jl11', '127.0.0.1', '内网IP', 'Chrome 8', 'Mac OS X', '0', '登录成功', '2022-04-14 23:17:29');
INSERT INTO `sys_logininfor` VALUES (1678, 'jl11', '127.0.0.1', '内网IP', 'Chrome 8', 'Mac OS X', '0', '退出成功', '2022-04-14 23:21:59');
INSERT INTO `sys_logininfor` VALUES (1679, 'jl12', '127.0.0.1', '内网IP', 'Chrome 8', 'Mac OS X', '0', '登录成功', '2022-04-14 23:22:05');
INSERT INTO `sys_logininfor` VALUES (1680, 'jl12', '127.0.0.1', '内网IP', 'Chrome 8', 'Mac OS X', '0', '登录成功', '2022-04-14 23:27:38');
INSERT INTO `sys_logininfor` VALUES (1681, 'jl12', '127.0.0.1', '内网IP', 'Chrome 8', 'Mac OS X', '0', '登录成功', '2022-04-14 23:34:57');
INSERT INTO `sys_logininfor` VALUES (1682, 'jl11', '127.0.0.1', '内网IP', 'Chrome 8', 'Mac OS X', '0', '登录成功', '2022-04-14 23:35:30');
INSERT INTO `sys_logininfor` VALUES (1683, 'jl12', '127.0.0.1', '内网IP', 'Chrome 8', 'Mac OS X', '0', '登录成功', '2022-04-14 23:44:58');
INSERT INTO `sys_logininfor` VALUES (1684, 'jl12', '127.0.0.1', '内网IP', 'Chrome 8', 'Mac OS X', '0', '登录成功', '2022-04-14 23:48:54');
INSERT INTO `sys_logininfor` VALUES (1685, 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Mac OS X', '0', '登录成功', '2022-04-15 21:50:04');
INSERT INTO `sys_logininfor` VALUES (1686, 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Mac OS X', '0', '登录成功', '2022-04-15 22:02:46');
INSERT INTO `sys_logininfor` VALUES (1687, 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Mac OS X', '0', '退出成功', '2022-04-15 22:03:00');
INSERT INTO `sys_logininfor` VALUES (1688, 'jl11', '127.0.0.1', '内网IP', 'Chrome 8', 'Mac OS X', '0', '登录成功', '2022-04-15 22:03:07');
INSERT INTO `sys_logininfor` VALUES (1689, 'jl11', '127.0.0.1', '内网IP', 'Chrome 8', 'Mac OS X', '0', '登录成功', '2022-04-15 22:09:09');
INSERT INTO `sys_logininfor` VALUES (1690, 'jl12', '127.0.0.1', '内网IP', 'Chrome 8', 'Mac OS X', '0', '登录成功', '2022-04-15 22:12:43');
INSERT INTO `sys_logininfor` VALUES (1691, 'jl12', '127.0.0.1', '内网IP', 'Chrome 8', 'Mac OS X', '0', '退出成功', '2022-04-15 22:16:39');
INSERT INTO `sys_logininfor` VALUES (1692, 'jl11', '127.0.0.1', '内网IP', 'Chrome 8', 'Mac OS X', '0', '登录成功', '2022-04-15 22:16:49');
INSERT INTO `sys_logininfor` VALUES (1693, 'jl11', '127.0.0.1', '内网IP', 'Chrome 8', 'Mac OS X', '0', '退出成功', '2022-04-15 22:17:36');
INSERT INTO `sys_logininfor` VALUES (1694, 'jl12', '127.0.0.1', '内网IP', 'Chrome 8', 'Mac OS X', '0', '登录成功', '2022-04-15 22:17:41');
INSERT INTO `sys_logininfor` VALUES (1695, 'jl12', '127.0.0.1', '内网IP', 'Chrome 8', 'Mac OS X', '0', '登录成功', '2022-04-15 22:19:56');
INSERT INTO `sys_logininfor` VALUES (1696, 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '登录成功', '2022-04-16 14:47:43');
INSERT INTO `sys_logininfor` VALUES (1697, 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '退出成功', '2022-04-16 14:50:13');
INSERT INTO `sys_logininfor` VALUES (1698, 'cj11', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '1', '密码输入错误1次', '2022-04-16 14:50:19');
INSERT INTO `sys_logininfor` VALUES (1699, 'cj11', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '1', '密码输入错误2次', '2022-04-16 14:50:23');
INSERT INTO `sys_logininfor` VALUES (1700, 'cj1', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '1', '用户不存在/密码错误', '2022-04-16 14:50:27');
INSERT INTO `sys_logininfor` VALUES (1701, 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '登录成功', '2022-04-16 14:50:33');
INSERT INTO `sys_logininfor` VALUES (1702, 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '退出成功', '2022-04-16 14:50:54');
INSERT INTO `sys_logininfor` VALUES (1703, 'cj11', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '登录成功', '2022-04-16 14:51:01');
INSERT INTO `sys_logininfor` VALUES (1704, 'cj11', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '退出成功', '2022-04-16 15:00:35');
INSERT INTO `sys_logininfor` VALUES (1705, 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '登录成功', '2022-04-16 15:00:40');
INSERT INTO `sys_logininfor` VALUES (1706, 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '退出成功', '2022-04-16 15:01:37');
INSERT INTO `sys_logininfor` VALUES (1707, 'cj11', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '1', '密码输入错误1次', '2022-04-16 15:01:42');
INSERT INTO `sys_logininfor` VALUES (1708, 'cj11', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '登录成功', '2022-04-16 15:01:46');
INSERT INTO `sys_logininfor` VALUES (1709, 'cj11', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '登录成功', '2022-04-16 15:06:54');
INSERT INTO `sys_logininfor` VALUES (1710, 'cj11', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '登录成功', '2022-04-16 15:09:28');
INSERT INTO `sys_logininfor` VALUES (1711, 'cj11', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '退出成功', '2022-04-16 15:09:38');
INSERT INTO `sys_logininfor` VALUES (1712, 'cj12', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '1', '密码输入错误1次', '2022-04-16 15:09:43');
INSERT INTO `sys_logininfor` VALUES (1713, 'cj12', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '1', '密码输入错误2次', '2022-04-16 15:09:48');
INSERT INTO `sys_logininfor` VALUES (1714, 'jl11', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '登录成功', '2022-04-16 15:09:56');
INSERT INTO `sys_logininfor` VALUES (1715, 'jl11', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '退出成功', '2022-04-16 15:10:12');
INSERT INTO `sys_logininfor` VALUES (1716, 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '登录成功', '2022-04-16 16:29:45');
INSERT INTO `sys_logininfor` VALUES (1717, 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '退出成功', '2022-04-16 16:31:41');
INSERT INTO `sys_logininfor` VALUES (1718, 'cj11', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '1', '密码输入错误1次', '2022-04-16 16:37:20');
INSERT INTO `sys_logininfor` VALUES (1719, 'cj11', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '登录成功', '2022-04-16 16:37:27');
INSERT INTO `sys_logininfor` VALUES (1720, 'cj11', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '退出成功', '2022-04-16 16:41:01');
INSERT INTO `sys_logininfor` VALUES (1721, 'jl11', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '1', '密码输入错误1次', '2022-04-16 16:41:07');
INSERT INTO `sys_logininfor` VALUES (1722, 'jl11', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '登录成功', '2022-04-16 16:41:09');
INSERT INTO `sys_logininfor` VALUES (1723, 'jl11', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '退出成功', '2022-04-16 16:42:01');
INSERT INTO `sys_logininfor` VALUES (1724, 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Mac OS X', '0', '登录成功', '2022-04-16 23:38:32');
INSERT INTO `sys_logininfor` VALUES (1725, 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Mac OS X', '0', '退出成功', '2022-04-16 23:41:38');
INSERT INTO `sys_logininfor` VALUES (1726, 'cj11', '127.0.0.1', '内网IP', 'Chrome 8', 'Mac OS X', '0', '登录成功', '2022-04-16 23:41:43');
INSERT INTO `sys_logininfor` VALUES (1727, 'cj11', '127.0.0.1', '内网IP', 'Chrome 8', 'Mac OS X', '0', '登录成功', '2022-04-16 23:45:50');
INSERT INTO `sys_logininfor` VALUES (1728, 'cj11', '127.0.0.1', '内网IP', 'Chrome 8', 'Mac OS X', '0', '退出成功', '2022-04-16 23:48:43');
INSERT INTO `sys_logininfor` VALUES (1729, 'jl12', '127.0.0.1', '内网IP', 'Chrome 8', 'Mac OS X', '0', '登录成功', '2022-04-16 23:48:50');
INSERT INTO `sys_logininfor` VALUES (1730, 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Mac OS X', '0', '登录成功', '2022-04-17 09:36:26');
INSERT INTO `sys_logininfor` VALUES (1731, 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Mac OS X', '0', '退出成功', '2022-04-17 09:44:21');
INSERT INTO `sys_logininfor` VALUES (1732, 'cj11', '127.0.0.1', '内网IP', 'Chrome 8', 'Mac OS X', '0', '登录成功', '2022-04-17 09:44:28');
INSERT INTO `sys_logininfor` VALUES (1733, 'cj11', '127.0.0.1', '内网IP', 'Chrome 8', 'Mac OS X', '0', '退出成功', '2022-04-17 09:47:26');
INSERT INTO `sys_logininfor` VALUES (1734, 'cj11', '127.0.0.1', '内网IP', 'Chrome 8', 'Mac OS X', '0', '登录成功', '2022-04-17 09:48:30');
INSERT INTO `sys_logininfor` VALUES (1735, 'cj11', '127.0.0.1', '内网IP', 'Chrome 8', 'Mac OS X', '0', '登录成功', '2022-04-17 09:51:23');
INSERT INTO `sys_logininfor` VALUES (1736, 'cj11', '127.0.0.1', '内网IP', 'Chrome 8', 'Mac OS X', '0', '登录成功', '2022-04-17 10:15:53');
INSERT INTO `sys_logininfor` VALUES (1737, 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Mac OS X', '0', '登录成功', '2022-04-17 11:26:29');
INSERT INTO `sys_logininfor` VALUES (1738, 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Mac OS X', '0', '退出成功', '2022-04-17 11:28:09');
INSERT INTO `sys_logininfor` VALUES (1739, 'js11', '127.0.0.1', '内网IP', 'Chrome 8', 'Mac OS X', '0', '登录成功', '2022-04-17 11:28:27');
INSERT INTO `sys_logininfor` VALUES (1740, 'js11', '127.0.0.1', '内网IP', 'Chrome 8', 'Mac OS X', '0', '退出成功', '2022-04-17 11:29:54');
INSERT INTO `sys_logininfor` VALUES (1741, 'jl11', '127.0.0.1', '内网IP', 'Chrome 8', 'Mac OS X', '0', '登录成功', '2022-04-17 11:30:00');
INSERT INTO `sys_logininfor` VALUES (1742, 'jl11', '127.0.0.1', '内网IP', 'Chrome 8', 'Mac OS X', '0', '退出成功', '2022-04-17 11:30:22');
INSERT INTO `sys_logininfor` VALUES (1743, 'cj11', '127.0.0.1', '内网IP', 'Chrome 8', 'Mac OS X', '0', '登录成功', '2022-04-17 11:30:27');
INSERT INTO `sys_logininfor` VALUES (1744, 'cj11', '127.0.0.1', '内网IP', 'Chrome 8', 'Mac OS X', '0', '退出成功', '2022-04-17 11:31:04');
INSERT INTO `sys_logininfor` VALUES (1745, 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Mac OS X', '0', '登录成功', '2022-04-17 11:36:40');
INSERT INTO `sys_logininfor` VALUES (1746, 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Mac OS X', '0', '退出成功', '2022-04-17 11:40:06');
INSERT INTO `sys_logininfor` VALUES (1747, 'cj11', '127.0.0.1', '内网IP', 'Chrome 8', 'Mac OS X', '0', '登录成功', '2022-04-17 11:40:16');
INSERT INTO `sys_logininfor` VALUES (1748, 'cj11', '127.0.0.1', '内网IP', 'Chrome 8', 'Mac OS X', '0', '退出成功', '2022-04-17 11:47:58');
INSERT INTO `sys_logininfor` VALUES (1749, 'cj12', '127.0.0.1', '内网IP', 'Chrome 8', 'Mac OS X', '1', '密码输入错误1次', '2022-04-17 11:48:03');
INSERT INTO `sys_logininfor` VALUES (1750, 'cj12', '127.0.0.1', '内网IP', 'Chrome 8', 'Mac OS X', '1', '密码输入错误2次', '2022-04-17 11:48:08');
INSERT INTO `sys_logininfor` VALUES (1751, 'jl11', '127.0.0.1', '内网IP', 'Chrome 8', 'Mac OS X', '0', '登录成功', '2022-04-17 11:48:18');
INSERT INTO `sys_logininfor` VALUES (1752, 'jl11', '127.0.0.1', '内网IP', 'Chrome 8', 'Mac OS X', '0', '登录成功', '2022-04-17 11:49:29');
INSERT INTO `sys_logininfor` VALUES (1753, 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Mac OS X', '0', '登录成功', '2022-04-17 12:27:11');
INSERT INTO `sys_logininfor` VALUES (1754, 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Mac OS X', '0', '退出成功', '2022-04-17 12:31:52');
INSERT INTO `sys_logininfor` VALUES (1755, 'cj11', '127.0.0.1', '内网IP', 'Chrome 8', 'Mac OS X', '0', '登录成功', '2022-04-17 12:31:58');
INSERT INTO `sys_logininfor` VALUES (1756, 'cj11', '127.0.0.1', '内网IP', 'Chrome 8', 'Mac OS X', '0', '退出成功', '2022-04-17 12:32:30');
INSERT INTO `sys_logininfor` VALUES (1757, 'cj11', '127.0.0.1', '内网IP', 'Chrome 8', 'Mac OS X', '0', '登录成功', '2022-04-17 12:34:21');
INSERT INTO `sys_logininfor` VALUES (1758, 'cj11', '127.0.0.1', '内网IP', 'Chrome 8', 'Mac OS X', '0', '退出成功', '2022-04-17 12:41:44');
INSERT INTO `sys_logininfor` VALUES (1759, 'jl11', '127.0.0.1', '内网IP', 'Chrome 8', 'Mac OS X', '0', '登录成功', '2022-04-17 12:41:51');
INSERT INTO `sys_logininfor` VALUES (1760, 'jl11', '127.0.0.1', '内网IP', 'Chrome 8', 'Mac OS X', '0', '退出成功', '2022-04-17 12:42:43');
INSERT INTO `sys_logininfor` VALUES (1761, 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Mac OS X', '0', '登录成功', '2022-04-17 13:56:28');
INSERT INTO `sys_logininfor` VALUES (1762, 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Mac OS X', '0', '退出成功', '2022-04-17 14:00:59');
INSERT INTO `sys_logininfor` VALUES (1763, 'cj11', '127.0.0.1', '内网IP', 'Chrome 8', 'Mac OS X', '0', '登录成功', '2022-04-17 14:01:06');
INSERT INTO `sys_logininfor` VALUES (1764, 'cj11', '127.0.0.1', '内网IP', 'Chrome 8', 'Mac OS X', '0', '退出成功', '2022-04-17 14:03:48');
INSERT INTO `sys_logininfor` VALUES (1765, 'jl11', '127.0.0.1', '内网IP', 'Chrome 8', 'Mac OS X', '0', '登录成功', '2022-04-17 14:03:54');
INSERT INTO `sys_logininfor` VALUES (1766, 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '登录成功', '2022-04-17 17:18:43');
INSERT INTO `sys_logininfor` VALUES (1767, 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '退出成功', '2022-04-17 17:23:28');
INSERT INTO `sys_logininfor` VALUES (1768, 'cj11', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '登录成功', '2022-04-17 17:23:32');
INSERT INTO `sys_logininfor` VALUES (1769, 'cj11', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '登录成功', '2022-04-17 17:25:11');
INSERT INTO `sys_logininfor` VALUES (1770, 'cj11', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '退出成功', '2022-04-17 17:25:47');
INSERT INTO `sys_logininfor` VALUES (1771, 'jl11', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '登录成功', '2022-04-17 17:25:55');
INSERT INTO `sys_logininfor` VALUES (1772, 'jl11', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '退出成功', '2022-04-17 17:26:52');
INSERT INTO `sys_logininfor` VALUES (1773, 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '登录成功', '2022-04-17 17:26:56');
INSERT INTO `sys_logininfor` VALUES (1774, 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '退出成功', '2022-04-17 17:28:16');
INSERT INTO `sys_logininfor` VALUES (1775, 'jl11', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '登录成功', '2022-04-17 17:28:21');
INSERT INTO `sys_logininfor` VALUES (1776, 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '登录成功', '2022-04-17 18:29:57');
INSERT INTO `sys_logininfor` VALUES (1777, 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '退出成功', '2022-04-17 18:33:12');
INSERT INTO `sys_logininfor` VALUES (1778, 'cj11', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '登录成功', '2022-04-17 18:33:18');
INSERT INTO `sys_logininfor` VALUES (1779, 'cj11', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '登录成功', '2022-04-17 18:36:27');
INSERT INTO `sys_logininfor` VALUES (1780, 'cj11', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '退出成功', '2022-04-17 18:37:55');
INSERT INTO `sys_logininfor` VALUES (1781, 'jl11', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '登录成功', '2022-04-17 18:38:10');
INSERT INTO `sys_logininfor` VALUES (1782, 'jl11', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '退出成功', '2022-04-17 18:41:41');
INSERT INTO `sys_logininfor` VALUES (1783, 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '登录成功', '2022-04-17 18:41:48');
INSERT INTO `sys_logininfor` VALUES (1784, 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '退出成功', '2022-04-17 18:43:59');
INSERT INTO `sys_logininfor` VALUES (1785, 'jl11', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '登录成功', '2022-04-17 18:44:06');
INSERT INTO `sys_logininfor` VALUES (1786, 'jl11', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '退出成功', '2022-04-17 18:44:35');
INSERT INTO `sys_logininfor` VALUES (1787, 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '登录成功', '2022-04-18 01:43:36');
INSERT INTO `sys_logininfor` VALUES (1788, 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '退出成功', '2022-04-18 01:48:32');
INSERT INTO `sys_logininfor` VALUES (1789, 'cj11', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '登录成功', '2022-04-18 01:48:53');
INSERT INTO `sys_logininfor` VALUES (1790, 'cj11', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '退出成功', '2022-04-18 01:49:26');
INSERT INTO `sys_logininfor` VALUES (1791, 'jl11', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '登录成功', '2022-04-18 01:49:32');
INSERT INTO `sys_logininfor` VALUES (1792, 'jl11', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '退出成功', '2022-04-18 01:49:56');
INSERT INTO `sys_logininfor` VALUES (1793, 'cj11', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '登录成功', '2022-04-18 01:50:01');
INSERT INTO `sys_logininfor` VALUES (1794, 'jl11', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '登录成功', '2022-04-18 01:53:34');
INSERT INTO `sys_logininfor` VALUES (1795, 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '登录成功', '2022-04-18 14:30:54');
INSERT INTO `sys_logininfor` VALUES (1796, 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '退出成功', '2022-04-18 14:32:59');
INSERT INTO `sys_logininfor` VALUES (1797, 'jl11', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '登录成功', '2022-04-18 14:33:07');
INSERT INTO `sys_logininfor` VALUES (1798, 'jl11', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '登录成功', '2022-04-18 14:34:14');
INSERT INTO `sys_logininfor` VALUES (1799, 'jl11', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '登录成功', '2022-04-18 14:35:50');
INSERT INTO `sys_logininfor` VALUES (1800, 'jl11', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '登录成功', '2022-04-18 14:38:42');
INSERT INTO `sys_logininfor` VALUES (1801, 'jl11', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '退出成功', '2022-04-18 14:39:04');
INSERT INTO `sys_logininfor` VALUES (1802, 'js11', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '登录成功', '2022-04-18 14:39:10');
INSERT INTO `sys_logininfor` VALUES (1803, 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '1', '密码输入错误1次', '2022-04-18 15:05:18');
INSERT INTO `sys_logininfor` VALUES (1804, 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '登录成功', '2022-04-18 15:05:22');
INSERT INTO `sys_logininfor` VALUES (1805, 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '退出成功', '2022-04-18 15:07:29');
INSERT INTO `sys_logininfor` VALUES (1806, 'jl11', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '登录成功', '2022-04-18 15:07:34');
INSERT INTO `sys_logininfor` VALUES (1807, 'jl11', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '退出成功', '2022-04-18 15:08:09');
INSERT INTO `sys_logininfor` VALUES (1808, 'js11', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '登录成功', '2022-04-18 15:08:15');
INSERT INTO `sys_logininfor` VALUES (1809, 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '登录成功', '2022-04-18 15:21:24');
INSERT INTO `sys_logininfor` VALUES (1810, 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '退出成功', '2022-04-18 15:24:36');
INSERT INTO `sys_logininfor` VALUES (1811, 'cj11', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '登录成功', '2022-04-18 15:24:41');
INSERT INTO `sys_logininfor` VALUES (1812, 'cj11', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '退出成功', '2022-04-18 15:25:13');
INSERT INTO `sys_logininfor` VALUES (1813, 'js11', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '1', '密码输入错误1次', '2022-04-18 15:25:19');
INSERT INTO `sys_logininfor` VALUES (1814, 'js11', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '登录成功', '2022-04-18 15:25:22');
INSERT INTO `sys_logininfor` VALUES (1815, 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '登录成功', '2022-04-18 15:52:13');
INSERT INTO `sys_logininfor` VALUES (1816, 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '退出成功', '2022-04-18 15:58:12');
INSERT INTO `sys_logininfor` VALUES (1817, 'cj11', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '登录成功', '2022-04-18 15:58:17');
INSERT INTO `sys_logininfor` VALUES (1818, 'cj11', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '登录成功', '2022-04-18 15:59:36');
INSERT INTO `sys_logininfor` VALUES (1819, 'cj11', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '登录成功', '2022-04-18 16:03:01');
INSERT INTO `sys_logininfor` VALUES (1820, 'cj11', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '登录成功', '2022-04-18 16:04:26');
INSERT INTO `sys_logininfor` VALUES (1821, 'cj11', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '退出成功', '2022-04-18 16:04:56');
INSERT INTO `sys_logininfor` VALUES (1822, 'jl11', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '登录成功', '2022-04-18 16:05:01');
INSERT INTO `sys_logininfor` VALUES (1823, 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '登录成功', '2022-04-18 16:17:44');
INSERT INTO `sys_logininfor` VALUES (1824, 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '退出成功', '2022-04-18 16:20:53');
INSERT INTO `sys_logininfor` VALUES (1825, 'cj11', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '登录成功', '2022-04-18 16:20:58');
INSERT INTO `sys_logininfor` VALUES (1826, 'cj11', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '退出成功', '2022-04-18 16:21:30');
INSERT INTO `sys_logininfor` VALUES (1827, 'cj11', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '登录成功', '2022-04-18 16:21:34');
INSERT INTO `sys_logininfor` VALUES (1828, 'cj11', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '退出成功', '2022-04-18 16:21:47');
INSERT INTO `sys_logininfor` VALUES (1829, 'jl11', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '登录成功', '2022-04-18 16:21:51');
INSERT INTO `sys_logininfor` VALUES (1830, 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '登录成功', '2022-04-26 20:23:21');
INSERT INTO `sys_logininfor` VALUES (1831, 'admin', '127.0.0.1', '内网IP', 'Chrome 9', 'Mac OS X', '1', '密码输入错误1次', '2022-10-24 11:48:24');
INSERT INTO `sys_logininfor` VALUES (1832, 'admin', '127.0.0.1', '内网IP', 'Chrome 9', 'Mac OS X', '0', '登录成功', '2022-10-24 11:48:29');
INSERT INTO `sys_logininfor` VALUES (1833, 'admin', '127.0.0.1', '内网IP', 'Chrome 9', 'Windows 10', '1', '密码输入错误1次', '2022-10-24 14:19:27');
INSERT INTO `sys_logininfor` VALUES (1834, 'admin', '127.0.0.1', '内网IP', 'Chrome 9', 'Windows 10', '1', '密码输入错误2次', '2022-10-24 14:19:30');
INSERT INTO `sys_logininfor` VALUES (1835, 'admin', '127.0.0.1', '内网IP', 'Chrome 9', 'Windows 10', '1', '密码输入错误3次', '2022-10-24 14:19:35');
INSERT INTO `sys_logininfor` VALUES (1836, 'admin', '127.0.0.1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2022-10-24 14:19:37');
INSERT INTO `sys_logininfor` VALUES (1837, 'admin', '127.0.0.1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2022-10-24 15:28:19');
INSERT INTO `sys_logininfor` VALUES (1838, 'admin', '127.0.0.1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2022-10-24 15:30:03');
INSERT INTO `sys_logininfor` VALUES (1839, 'admin', '127.0.0.1', '内网IP', 'Chrome 9', 'Windows 10', '0', '退出成功', '2022-10-24 15:52:08');
INSERT INTO `sys_logininfor` VALUES (1840, 'admin', '127.0.0.1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2022-10-24 16:58:14');
INSERT INTO `sys_logininfor` VALUES (1841, 'admin', '127.0.0.1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2022-10-24 17:04:18');
INSERT INTO `sys_logininfor` VALUES (1842, 'admin', '127.0.0.1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2022-10-24 17:05:34');
INSERT INTO `sys_logininfor` VALUES (1843, 'admin', '127.0.0.1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2022-10-26 23:14:42');
INSERT INTO `sys_logininfor` VALUES (1844, 'admin', '127.0.0.1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2022-10-26 23:18:31');
INSERT INTO `sys_logininfor` VALUES (1845, 'admin', '127.0.0.1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2022-10-26 23:24:30');
INSERT INTO `sys_logininfor` VALUES (1846, 'admin', '127.0.0.1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2022-10-27 21:52:35');
INSERT INTO `sys_logininfor` VALUES (1847, 'admin', '127.0.0.1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2022-10-27 22:14:41');
INSERT INTO `sys_logininfor` VALUES (1848, 'admin', '127.0.0.1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2022-10-27 22:16:13');
INSERT INTO `sys_logininfor` VALUES (1849, 'admin', '127.0.0.1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2022-10-27 22:18:31');
INSERT INTO `sys_logininfor` VALUES (1850, 'admin', '127.0.0.1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2022-10-27 22:27:34');
INSERT INTO `sys_logininfor` VALUES (1851, 'admin', '127.0.0.1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2022-10-27 22:32:38');
INSERT INTO `sys_logininfor` VALUES (1852, 'admin', '127.0.0.1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2022-10-29 22:28:55');
INSERT INTO `sys_logininfor` VALUES (1853, 'admin', '127.0.0.1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2022-10-29 22:30:07');
INSERT INTO `sys_logininfor` VALUES (1854, 'admin', '127.0.0.1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2022-10-29 23:15:33');
INSERT INTO `sys_logininfor` VALUES (1855, 'admin', '127.0.0.1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2022-10-30 10:49:47');
INSERT INTO `sys_logininfor` VALUES (1856, 'admin', '127.0.0.1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2022-10-30 11:26:14');
INSERT INTO `sys_logininfor` VALUES (1857, 'admin', '127.0.0.1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2022-10-30 11:35:05');
INSERT INTO `sys_logininfor` VALUES (1858, 'admin', '127.0.0.1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2022-10-30 11:49:35');
INSERT INTO `sys_logininfor` VALUES (1859, 'admin', '127.0.0.1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2022-10-30 11:51:52');
INSERT INTO `sys_logininfor` VALUES (1860, 'admin', '127.0.0.1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2022-10-30 12:25:48');
INSERT INTO `sys_logininfor` VALUES (1861, 'admin', '127.0.0.1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2022-10-30 12:32:26');
INSERT INTO `sys_logininfor` VALUES (1862, 'admin', '127.0.0.1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2022-10-30 12:49:42');
INSERT INTO `sys_logininfor` VALUES (1863, 'admin', '127.0.0.1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2022-10-30 12:58:02');
INSERT INTO `sys_logininfor` VALUES (1864, 'admin', '127.0.0.1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2022-10-30 14:19:03');
INSERT INTO `sys_logininfor` VALUES (1865, 'admin', '127.0.0.1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2022-10-30 14:22:31');
INSERT INTO `sys_logininfor` VALUES (1866, 'admin', '127.0.0.1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2022-10-30 14:25:23');
INSERT INTO `sys_logininfor` VALUES (1867, 'admin', '127.0.0.1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2022-10-30 14:27:19');
INSERT INTO `sys_logininfor` VALUES (1868, 'admin', '127.0.0.1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2022-10-30 14:29:49');
INSERT INTO `sys_logininfor` VALUES (1869, 'admin', '127.0.0.1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2022-10-30 14:46:58');
INSERT INTO `sys_logininfor` VALUES (1870, 'admin', '127.0.0.1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2022-10-30 23:19:24');
INSERT INTO `sys_logininfor` VALUES (1871, 'admin', '127.0.0.1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2022-10-30 23:21:09');
INSERT INTO `sys_logininfor` VALUES (1872, 'admin', '127.0.0.1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2022-10-30 23:21:12');
INSERT INTO `sys_logininfor` VALUES (1873, 'admin', '127.0.0.1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2022-10-30 23:33:47');
INSERT INTO `sys_logininfor` VALUES (1874, 'admin', '127.0.0.1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2022-10-31 00:02:04');
INSERT INTO `sys_logininfor` VALUES (1875, 'admin', '127.0.0.1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2022-10-31 00:05:05');
INSERT INTO `sys_logininfor` VALUES (1876, 'admin', '127.0.0.1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2022-10-31 00:10:46');
INSERT INTO `sys_logininfor` VALUES (1877, 'admin', '127.0.0.1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2022-10-31 00:48:52');
INSERT INTO `sys_logininfor` VALUES (1878, 'admin', '127.0.0.1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2022-10-31 00:54:38');
INSERT INTO `sys_logininfor` VALUES (1879, 'admin', '127.0.0.1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2022-10-31 00:58:43');
INSERT INTO `sys_logininfor` VALUES (1880, 'admin', '127.0.0.1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2022-10-31 01:01:23');
INSERT INTO `sys_logininfor` VALUES (1881, 'admin', '127.0.0.1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2022-10-31 01:05:29');
INSERT INTO `sys_logininfor` VALUES (1882, 'admin', '127.0.0.1', '内网IP', 'Chrome 9', 'Windows 10', '0', '退出成功', '2022-10-31 01:16:22');
INSERT INTO `sys_logininfor` VALUES (1883, 'zhangsan', '127.0.0.1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2022-10-31 01:16:27');
INSERT INTO `sys_logininfor` VALUES (1884, 'admin', '127.0.0.1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2022-10-31 01:19:54');
INSERT INTO `sys_logininfor` VALUES (1885, 'admin', '127.0.0.1', '内网IP', 'Chrome 9', 'Windows 10', '0', '退出成功', '2022-10-31 01:20:00');
INSERT INTO `sys_logininfor` VALUES (1886, 'lisi', '127.0.0.1', '内网IP', 'Chrome 9', 'Windows 10', '1', '密码输入错误1次', '2022-10-31 01:20:05');
INSERT INTO `sys_logininfor` VALUES (1887, 'zhangsan', '127.0.0.1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2022-10-31 01:20:11');
INSERT INTO `sys_logininfor` VALUES (1888, 'admin', '127.0.0.1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2022-10-31 12:02:29');
INSERT INTO `sys_logininfor` VALUES (1889, 'admin', '127.0.0.1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2022-10-31 12:03:39');
INSERT INTO `sys_logininfor` VALUES (1890, 'admin', '127.0.0.1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2022-10-31 12:05:45');
INSERT INTO `sys_logininfor` VALUES (1891, 'admin', '127.0.0.1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2022-10-31 12:23:45');
INSERT INTO `sys_logininfor` VALUES (1892, 'admin', '127.0.0.1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2022-10-31 12:28:04');
INSERT INTO `sys_logininfor` VALUES (1893, 'admin', '127.0.0.1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2022-10-31 12:29:44');
INSERT INTO `sys_logininfor` VALUES (1894, 'admin', '127.0.0.1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2022-10-31 12:51:28');
INSERT INTO `sys_logininfor` VALUES (1895, 'admin', '127.0.0.1', '内网IP', 'Chrome 9', 'Windows 10', '0', '退出成功', '2022-10-31 12:52:48');
INSERT INTO `sys_logininfor` VALUES (1896, 'zhangsan', '127.0.0.1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2022-10-31 12:52:54');
INSERT INTO `sys_logininfor` VALUES (1897, 'zhangsan', '127.0.0.1', '内网IP', 'Chrome 9', 'Windows 10', '0', '退出成功', '2022-10-31 12:54:02');
INSERT INTO `sys_logininfor` VALUES (1898, 'admin', '127.0.0.1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2022-10-31 12:54:04');
INSERT INTO `sys_logininfor` VALUES (1899, 'admin', '127.0.0.1', '内网IP', 'Chrome 9', 'Windows 10', '0', '退出成功', '2022-10-31 12:54:16');
INSERT INTO `sys_logininfor` VALUES (1900, 'zhangsan', '127.0.0.1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2022-10-31 12:54:24');
INSERT INTO `sys_logininfor` VALUES (1901, 'zhangsan', '127.0.0.1', '内网IP', 'Chrome 9', 'Windows 10', '0', '退出成功', '2022-10-31 12:54:48');
INSERT INTO `sys_logininfor` VALUES (1902, 'admin', '127.0.0.1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2022-10-31 12:54:49');
INSERT INTO `sys_logininfor` VALUES (1903, 'admin', '127.0.0.1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2022-10-31 12:57:06');
INSERT INTO `sys_logininfor` VALUES (1904, 'admin', '127.0.0.1', '内网IP', 'Chrome 9', 'Windows 10', '0', '退出成功', '2022-10-31 12:57:55');
INSERT INTO `sys_logininfor` VALUES (1905, 'zhangsan', '127.0.0.1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2022-10-31 12:57:59');
INSERT INTO `sys_logininfor` VALUES (1906, 'zhangsan', '127.0.0.1', '内网IP', 'Chrome 9', 'Windows 10', '0', '退出成功', '2022-10-31 12:58:09');
INSERT INTO `sys_logininfor` VALUES (1907, 'admin', '127.0.0.1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2022-10-31 12:58:10');
INSERT INTO `sys_logininfor` VALUES (1908, 'admin', '127.0.0.1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2022-10-31 13:14:56');
INSERT INTO `sys_logininfor` VALUES (1909, 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '1', '密码输入错误1次', '2022-09-04 20:47:06');
INSERT INTO `sys_logininfor` VALUES (1910, 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '1', '密码输入错误2次', '2022-09-04 20:47:09');
INSERT INTO `sys_logininfor` VALUES (1911, 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '1', '用户不存在/密码错误', '2022-09-04 20:47:12');
INSERT INTO `sys_logininfor` VALUES (1912, 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '1', '密码输入错误3次', '2022-09-04 20:47:15');
INSERT INTO `sys_logininfor` VALUES (1913, 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '1', '密码输入错误1次', '2022-09-04 20:54:46');
INSERT INTO `sys_logininfor` VALUES (1914, 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '登录成功', '2022-09-04 20:54:53');
INSERT INTO `sys_logininfor` VALUES (1915, 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '登录成功', '2022-09-04 20:59:32');
INSERT INTO `sys_logininfor` VALUES (1916, 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '退出成功', '2022-09-04 21:08:03');
INSERT INTO `sys_logininfor` VALUES (1917, 'zhangsan', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '登录成功', '2022-09-04 21:08:09');
INSERT INTO `sys_logininfor` VALUES (1918, 'zhangsan', '127.0.0.1', '内网IP', 'Firefox 10', 'Windows 10', '0', '登录成功', '2022-09-04 21:12:13');
INSERT INTO `sys_logininfor` VALUES (1919, 'zhangsan', '127.0.0.1', '内网IP', 'Firefox 10', 'Windows 10', '0', '登录成功', '2022-09-04 21:13:50');
INSERT INTO `sys_logininfor` VALUES (1920, 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '登录成功', '2022-09-04 21:14:20');
INSERT INTO `sys_logininfor` VALUES (1921, 'jiaolian1', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '登录成功', '2022-09-04 21:15:41');
INSERT INTO `sys_logininfor` VALUES (1922, 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '退出成功', '2022-09-04 21:41:17');
INSERT INTO `sys_logininfor` VALUES (1923, 'zhangsan', '127.0.0.1', '内网IP', 'Firefox 10', 'Windows 10', '0', '退出成功', '2022-09-04 21:41:24');
INSERT INTO `sys_logininfor` VALUES (1924, 'admin', '127.0.0.1', '内网IP', 'Firefox 10', 'Windows 10', '0', '登录成功', '2022-09-04 21:41:27');
INSERT INTO `sys_logininfor` VALUES (1925, 'admin', '127.0.0.1', '内网IP', 'Firefox 10', 'Windows 10', '0', '登录成功', '2022-09-04 21:53:17');
INSERT INTO `sys_logininfor` VALUES (1926, 'lisi', '127.0.0.1', '内网IP', 'Firefox 10', 'Windows 10', '1', '密码输入错误1次', '2022-09-04 22:02:45');
INSERT INTO `sys_logininfor` VALUES (1927, 'admin', '127.0.0.1', '内网IP', 'Firefox 10', 'Windows 10', '0', '登录成功', '2022-09-04 22:02:50');
INSERT INTO `sys_logininfor` VALUES (1928, 'admin', '127.0.0.1', '内网IP', 'Firefox 10', 'Windows 10', '0', '退出成功', '2022-09-04 22:03:48');
INSERT INTO `sys_logininfor` VALUES (1929, 'lisi', '127.0.0.1', '内网IP', 'Firefox 10', 'Windows 10', '1', '密码输入错误2次', '2022-09-04 22:03:52');
INSERT INTO `sys_logininfor` VALUES (1930, 'lisi', '127.0.0.1', '内网IP', 'Firefox 10', 'Windows 10', '1', '密码输入错误1次', '2022-09-04 22:06:24');
INSERT INTO `sys_logininfor` VALUES (1931, 'lisi', '127.0.0.1', '内网IP', 'Firefox 10', 'Windows 10', '0', '登录成功', '2022-09-04 22:06:27');
INSERT INTO `sys_logininfor` VALUES (1932, 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '登录成功', '2022-09-04 22:13:15');
INSERT INTO `sys_logininfor` VALUES (1933, 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '退出成功', '2022-09-04 22:14:05');
INSERT INTO `sys_logininfor` VALUES (1934, 'zhangsan', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '登录成功', '2022-09-04 22:14:10');
INSERT INTO `sys_logininfor` VALUES (1935, 'lisi', '127.0.0.1', '内网IP', 'Firefox 10', 'Windows 10', '0', '退出成功', '2022-09-04 22:15:50');
INSERT INTO `sys_logininfor` VALUES (1936, 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '登录成功', '2022-09-04 22:16:08');
...
) ENGINE = InnoDB AUTO_INCREMENT = 2310 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '菜单权限表' ROW_FORMAT = Compact;
...
INSERT INTO `sys_menu` VALUES (100, '用户管理', 1, 120, '/system/user', 3, 'menuItem', 'C', '0', 'system:user:view', '#', 'admin', '2018-03-16 11:33:00', 'admin', '2022-04-12 16:54:35', '用户管理菜单', NULL, NULL, 0);
...
INSERT INTO `sys_menu` VALUES (2292, '俱乐部管理', 0, 100, '#', 2, 'menuItem', 'M', '0', '', 'fa fa-file-word-o', 'admin', '2022-10-24 15:32:00', 'admin', '2022-10-29 23:15:54', '', NULL, NULL, 0);
INSERT INTO `sys_menu` VALUES (2293, '会员管理', 2292, 5, '/club/member', 2, 'menuItem', 'C', '0', '', '#', 'admin', '2022-10-24 15:32:19', 'admin', '2022-10-31 01:06:10', '', NULL, NULL, 0);
INSERT INTO `sys_menu` VALUES (2294, '会员等级', 2292, 20, '/club/level', 2, 'menuItem', 'C', '0', NULL, '#', 'admin', '2022-10-24 16:58:45', '', NULL, '', NULL, NULL, 0);
INSERT INTO `sys_menu` VALUES (2295, '项目管理', 2292, 10, '/club/project', 2, 'menuItem', 'C', '0', NULL, '#', 'admin', '2022-10-27 21:53:00', '', NULL, '', NULL, NULL, 0);
INSERT INTO `sys_menu` VALUES (2296, '器械管理', 2292, 20, '/club/machine', 2, 'menuItem', 'C', '0', NULL, '#', 'admin', '2022-10-27 21:53:26', '', NULL, '', NULL, NULL, 0);
INSERT INTO `sys_menu` VALUES (2297, '教练管理', 2292, 30, '/club/coach', 2, 'menuItem', 'C', '0', NULL, '#', 'admin', '2022-10-29 22:35:21', '', NULL, '', NULL, NULL, 0);
INSERT INTO `sys_menu` VALUES (2298, '论坛管理', 0, 80, '#', 2, 'menuItem', 'M', '0', '', 'fa fa-circle-thin', 'admin', '2022-10-29 23:16:26', 'admin', '2022-10-29 23:16:34', '', NULL, NULL, 0);
INSERT INTO `sys_menu` VALUES (2299, '版块管理', 2298, 100, '/bbs/section', 2, 'menuItem', 'C', '0', NULL, '#', 'admin', '2022-10-29 23:16:56', '', NULL, '', NULL, NULL, 0);
INSERT INTO `sys_menu` VALUES (2300, '运动消费记录', 2292, 50, '/club/record', 2, 'menuItem', 'C', '0', NULL, '#', 'admin', '2022-10-30 23:21:39', '', NULL, '', NULL, NULL, 0);
INSERT INTO `sys_menu` VALUES (2301, '会员生日', 2292, 3, '/club/member/birth', 2, 'menuItem', 'C', '0', NULL, '#', 'admin', '2022-10-31 01:06:30', '', NULL, '', NULL, NULL, 0);
INSERT INTO `sys_menu` VALUES (2302, '新增', 2300, 10, '#', 2, 'menuItem', 'F', '0', 'club:record:add', '#', 'admin', '2022-10-31 01:07:32', '', NULL, '', NULL, NULL, 0);
INSERT INTO `sys_menu` VALUES (2303, '修改', 2300, 9, '#', 2, 'menuItem', 'F', '0', 'club:record:edit', '#', 'admin', '2022-10-31 01:08:16', '', NULL, '', NULL, NULL, 0);
INSERT INTO `sys_menu` VALUES (2304, '删除', 2300, 8, '#', 2, 'menuItem', 'F', '0', 'club:record:delete', '#', 'admin', '2022-10-31 01:08:30', '', NULL, '', NULL, NULL, 0);
INSERT INTO `sys_menu` VALUES (2305, '详情新增', 2300, 6, '#', 2, 'menuItem', 'F', '0', 'club:detail:add', '#', 'admin', '2022-10-31 01:08:48', '', NULL, '', NULL, NULL, 0);
INSERT INTO `sys_menu` VALUES (2306, '详情删除', 2300, 4, '#', 2, 'menuItem', 'F', '0', 'club:detail:delete', '#', 'admin', '2022-10-31 01:09:08', '', NULL, '', NULL, NULL, 0);
INSERT INTO `sys_menu` VALUES (2307, '详情列表', 2300, 1, '#', 2, 'menuItem', 'F', '0', NULL, '#', 'admin', '2022-10-31 01:15:20', '', NULL, '', NULL, NULL, 0);
INSERT INTO `sys_menu` VALUES (2308, '余额提醒', 2292, 1, '/club/member/money', 2, 'menuItem', 'C', '0', NULL, '#', 'admin', '2022-10-31 12:24:32', '', NULL, '', NULL, NULL, 0);
INSERT INTO `sys_menu` VALUES (2309, '我的推荐项目', 2292, 49, '/club/project/recommend', 2, 'menuItem', 'C', '0', NULL, '#', 'admin', '2022-10-31 12:52:13', '', NULL, '', NULL, NULL, 0);
...
INSERT INTO `sys_menu_top` VALUES (2, '俱乐部管理', 100, '', 'fa fa-bar-chart', 'admin', '2022-04-13 21:05:38', 'admin', '2022-10-24 15:31:42', '', NULL, NULL, 0);
...
) ENGINE = MyISAM AUTO_INCREMENT = 258 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '操作日志记录' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of sys_oper_log
-- ----------------------------
INSERT INTO `sys_oper_log` VALUES (1, '部门管理', 3, 'com.study.web.controller.system.SysDeptController.remove()', 1, 'admin', 1, 0, '学校处室', '/gp/system/dept/remove/103', '127.0.0.1', NULL, '{ }', 0, NULL, '2022-04-12 21:34:41', '2022-04-12');
...
INSERT INTO `sys_oper_log` VALUES (47, '重置密码', 2, 'com.study.web.controller.system.SysUserController.resetPwd()', 1, 'admin', 1, 0, '根', '/gp/system/user/resetPwd/12699', '127.0.0.1', NULL, '{ }', 0, NULL, '2022-04-14 14:16:34', '2022-04-14');
...
INSERT INTO `sys_oper_log` VALUES (82, '重置密码', 2, 'com.study.web.controller.system.SysUserController.resetPwd()', 1, 'admin', 1, 0, '根', '/gp/system/user/resetPwd/12698', '127.0.0.1', NULL, '{ }', 0, NULL, '2022-04-16 14:50:42', '2022-04-16');
...
INSERT INTO `sys_oper_log` VALUES (85, '个人信息', 2, 'com.study.web.controller.system.SysProfileController.updateAvatar()', 1, 'admin', 1, 0, '根', '/gp/system/user/profile/updateAvatar', '127.0.0.1', NULL, '{ }', 0, NULL, '2022-04-13 21:05:01', '2022-04-13');
...
INSERT INTO `sys_oper_log` VALUES (116, '重置密码', 2, 'com.study.web.controller.system.SysUserController.resetPwd()', 1, 'admin', 1, 0, '根', '/gp/system/user/resetPwd/12700', '127.0.0.1', NULL, '{ }', 0, NULL, '2022-04-13 21:45:49', '2022-04-13');
...
INSERT INTO `sys_oper_log` VALUES (215, '部门管理', 2, 'com.study.web.controller.system.SysDeptController.editSave()', 1, 'admin', 1, 0, '根', '/gym/system/dept/edit', '127.0.0.1', NULL, '{\n  \"deptId\" : [ \"101\" ],\n  \"parentId\" : [ \"100\" ],\n  \"parentName\" : [ \"健身俱乐部\" ],\n  \"deptName\" : [ \"后勤部\" ],\n  \"shortName\" : [ \"后勤部\" ],\n  \"orderNum\" : [ \"3\" ],\n  \"leader\" : [ \"\" ],\n  \"phone\" : [ \"\" ],\n  \"email\" : [ \"\" ],\n  \"status\" : [ \"0\" ]\n}', 0, NULL, '2022-10-24 11:52:54', '2022-10-24');
INSERT INTO `sys_oper_log` VALUES (216, '部门管理', 1, 'com.study.web.controller.system.SysDeptController.addSave()', 1, 'admin', 1, 0, '根', '/gym/system/dept/add', '127.0.0.1', NULL, '{\n  \"parentId\" : [ \"100\" ],\n  \"deptName\" : [ \"后勤部\" ],\n  \"shortName\" : [ \"后勤部\" ],\n  \"orderNum\" : [ \"20\" ],\n  \"leader\" : [ \"\" ],\n  \"phone\" : [ \"\" ],\n  \"email\" : [ \"\" ],\n  \"status\" : [ \"0\" ]\n}', 0, NULL, '2022-10-24 11:53:07', '2022-10-24');
INSERT INTO `sys_oper_log` VALUES (217, '部门管理', 2, 'com.study.web.controller.system.SysDeptController.editSave()', 1, 'admin', 1, 0, '根', '/gym/system/dept/edit', '127.0.0.1', NULL, '{\n  \"deptId\" : [ \"213\" ],\n  \"parentId\" : [ \"100\" ],\n  \"parentName\" : [ \"健身俱乐部\" ],\n  \"deptName\" : [ \"会员部\" ],\n  \"shortName\" : [ \"会员部\" ],\n  \"orderNum\" : [ \"20\" ],\n  \"leader\" : [ \"\" ],\n  \"phone\" : [ \"\" ],\n  \"email\" : [ \"\" ],\n  \"status\" : [ \"0\" ]\n}', 0, NULL, '2022-10-24 11:53:24', '2022-10-24');
INSERT INTO `sys_oper_log` VALUES (218, '部门管理', 1, 'com.study.web.controller.system.SysDeptController.addSave()', 1, 'admin', 1, 0, '根', '/gym/system/dept/add', '127.0.0.1', NULL, '{\n  \"parentId\" : [ \"100\" ],\n  \"deptName\" : [ \"训练部\" ],\n  \"shortName\" : [ \"训练部\" ],\n  \"orderNum\" : [ \"20\" ],\n  \"leader\" : [ \"\" ],\n  \"phone\" : [ \"\" ],\n  \"email\" : [ \"\" ],\n  \"status\" : [ \"0\" ]\n}', 0, NULL, '2022-10-24 11:53:34', '2022-10-24');
INSERT INTO `sys_oper_log` VALUES (219, '部门管理', 1, 'com.study.web.controller.system.SysDeptController.addSave()', 1, 'admin', 1, 0, '根', '/gym/system/dept/add', '127.0.0.1', NULL, '{\n  \"parentId\" : [ \"100\" ],\n  \"deptName\" : [ \"设备管理部\" ],\n  \"shortName\" : [ \"设备管理部\" ],\n  \"orderNum\" : [ \"30\" ],\n  \"leader\" : [ \"\" ],\n  \"phone\" : [ \"\" ],\n  \"email\" : [ \"\" ],\n  \"status\" : [ \"0\" ]\n}', 0, NULL, '2022-10-24 11:54:01', '2022-10-24');
INSERT INTO `sys_oper_log` VALUES (220, '岗位管理', 2, 'com.study.web.controller.system.SysPostController.editSave()', 1, 'admin', 1, 0, '根', '/gym/system/post/edit', '127.0.0.1', NULL, '{\n  \"postId\" : [ \"5\" ],\n  \"postName\" : [ \"会员管理\" ],\n  \"postCode\" : [ \"hygl\" ],\n  \"postSort\" : [ \"5\" ],\n  \"status\" : [ \"0\" ],\n  \"remark\" : [ \"职责是办理会员卡相关业务\" ]\n}', 0, NULL, '2022-10-24 11:54:47', '2022-10-24');
INSERT INTO `sys_oper_log` VALUES (221, '岗位管理', 2, 'com.study.web.controller.system.SysPostController.editSave()', 1, 'admin', 1, 0, '根', '/gym/system/post/edit', '127.0.0.1', NULL, '{\n  \"postId\" : [ \"4\" ],\n  \"postName\" : [ \"设备管理\" ],\n  \"postCode\" : [ \"sbgl\" ],\n  \"postSort\" : [ \"30\" ],\n  \"status\" : [ \"0\" ],\n  \"remark\" : [ \"训练器材的日常维护保养\" ]\n}', 0, NULL, '2022-10-24 11:55:23', '2022-10-24');
INSERT INTO `sys_oper_log` VALUES (222, '岗位管理', 2, 'com.study.web.controller.system.SysPostController.editSave()', 1, 'admin', 1, 0, '根', '/gym/system/post/edit', '127.0.0.1', NULL, '{\n  \"postId\" : [ \"3\" ],\n  \"postName\" : [ \"训练管理\" ],\n  \"postCode\" : [ \"xlgl\" ],\n  \"postSort\" : [ \"3\" ],\n  \"status\" : [ \"0\" ],\n  \"remark\" : [ \"项目训练\" ]\n}', 0, NULL, '2022-10-24 11:55:43', '2022-10-24');
INSERT INTO `sys_oper_log` VALUES (223, '岗位管理', 2, 'com.study.web.controller.system.SysPostController.editSave()', 1, 'admin', 1, 0, '根', '/gym/system/post/edit', '127.0.0.1', NULL, '{\n  \"postId\" : [ \"2\" ],\n  \"postName\" : [ \"后勤管理\" ],\n  \"postCode\" : [ \"hqgl\" ],\n  \"postSort\" : [ \"2\" ],\n  \"status\" : [ \"0\" ],\n  \"remark\" : [ \"俱乐部内部人员，资产，财务等管理\" ]\n}', 0, NULL, '2022-10-24 11:56:31', '2022-10-24');
INSERT INTO `sys_oper_log` VALUES (224, '部门管理', 1, 'com.study.web.controller.system.SysDeptController.addSave()', 1, 'admin', 1, 0, '健身俱乐部', '/gym/system/dept/add', '127.0.0.1', NULL, '{\r\n  \"parentId\" : [ \"100\" ],\r\n  \"deptName\" : [ \"会员\" ],\r\n  \"shortName\" : [ \"会员\" ],\r\n  \"orderNum\" : [ \"0\" ],\r\n  \"leader\" : [ \"\" ],\r\n  \"phone\" : [ \"\" ],\r\n  \"email\" : [ \"\" ],\r\n  \"status\" : [ \"0\" ]\r\n}', 0, NULL, '2022-10-24 14:20:38', '2022-10-24');
INSERT INTO `sys_oper_log` VALUES (225, '角色管理', 1, 'com.study.web.controller.system.SysRoleController.addSave()', 1, 'admin', 1, 0, '健身俱乐部', '/gym/system/role/add', '127.0.0.1', NULL, '{\r\n  \"roleName\" : [ \"工作人员\" ],\r\n  \"roleKey\" : [ \"gzry\" ],\r\n  \"roleSort\" : [ \"90\" ],\r\n  \"status\" : [ \"0\" ],\r\n  \"remark\" : [ \"\" ],\r\n  \"menuIds\" : [ \"\" ]\r\n}', 0, NULL, '2022-10-24 14:21:44', '2022-10-24');
INSERT INTO `sys_oper_log` VALUES (226, '角色管理', 1, 'com.study.web.controller.system.SysRoleController.addSave()', 1, 'admin', 1, 0, '健身俱乐部', '/gym/system/role/add', '127.0.0.1', NULL, '{\r\n  \"roleName\" : [ \"会员\" ],\r\n  \"roleKey\" : [ \"hy\" ],\r\n  \"roleSort\" : [ \"80\" ],\r\n  \"status\" : [ \"0\" ],\r\n  \"remark\" : [ \"\" ],\r\n  \"menuIds\" : [ \"\" ]\r\n}', 0, NULL, '2022-10-24 14:22:03', '2022-10-24');
INSERT INTO `sys_oper_log` VALUES (227, '顶部菜单管理', 2, 'com.study.web.controller.system.SysMenuTopController.editSave()', 1, 'admin', 1, 0, '健身俱乐部', '/gym/system/menutop/edit', '127.0.0.1', NULL, '{\r\n  \"menuId\" : [ \"2\" ],\r\n  \"menuName\" : [ \"俱乐部管理\" ],\r\n  \"orderNum\" : [ \"100\" ],\r\n  \"icon\" : [ \"fa fa-bar-chart\" ]\r\n}', 0, NULL, '2022-10-24 15:31:43', '2022-10-24');
INSERT INTO `sys_oper_log` VALUES (228, '菜单管理', 1, 'com.study.web.controller.system.SysMenuController.addSave()', 1, 'admin', 1, 0, '健身俱乐部', '/gym/system/menu/add', '127.0.0.1', NULL, '{\r\n  \"parentId\" : [ \"0\" ],\r\n  \"menuTopId\" : [ \"2\" ],\r\n  \"menuType\" : [ \"M\" ],\r\n  \"menuName\" : [ \"俱乐部管理\" ],\r\n  \"url\" : [ \"\" ],\r\n  \"target\" : [ \"menuItem\" ],\r\n  \"perms\" : [ \"\" ],\r\n  \"orderNum\" : [ \"100\" ],\r\n  \"icon\" : [ \"\" ],\r\n  \"visible\" : [ \"0\" ]\r\n}', 0, NULL, '2022-10-24 15:32:02', '2022-10-24');
INSERT INTO `sys_oper_log` VALUES (229, '菜单管理', 1, 'com.study.web.controller.system.SysMenuController.addSave()', 1, 'admin', 1, 0, '健身俱乐部', '/gym/system/menu/add', '127.0.0.1', NULL, '{\r\n  \"parentId\" : [ \"2292\" ],\r\n  \"menuTopId\" : [ \"2\" ],\r\n  \"menuType\" : [ \"C\" ],\r\n  \"menuName\" : [ \"会员管理\" ],\r\n  \"url\" : [ \"/club/member\" ],\r\n  \"target\" : [ \"menuItem\" ],\r\n  \"perms\" : [ \"\" ],\r\n  \"orderNum\" : [ \"10\" ],\r\n  \"icon\" : [ \"\" ],\r\n  \"visible\" : [ \"0\" ]\r\n}', 0, NULL, '2022-10-24 15:32:20', '2022-10-24');
INSERT INTO `sys_oper_log` VALUES (230, '菜单管理', 1, 'com.study.web.controller.system.SysMenuController.addSave()', 1, 'admin', 1, 0, '健身俱乐部', '/gym/system/menu/add', '127.0.0.1', NULL, '{\r\n  \"parentId\" : [ \"2292\" ],\r\n  \"menuTopId\" : [ \"2\" ],\r\n  \"menuType\" : [ \"C\" ],\r\n  \"menuName\" : [ \"会员等级\" ],\r\n  \"url\" : [ \"/club/level\" ],\r\n  \"target\" : [ \"menuItem\" ],\r\n  \"perms\" : [ \"\" ],\r\n  \"orderNum\" : [ \"20\" ],\r\n  \"icon\" : [ \"\" ],\r\n  \"visible\" : [ \"0\" ]\r\n}', 0, NULL, '2022-10-24 16:58:46', '2022-10-24');
INSERT INTO `sys_oper_log` VALUES (231, '菜单管理', 1, 'com.study.web.controller.system.SysMenuController.addSave()', 1, 'admin', 1, 0, '健身俱乐部', '/gym/system/menu/add', '127.0.0.1', NULL, '{\r\n  \"parentId\" : [ \"2292\" ],\r\n  \"menuTopId\" : [ \"2\" ],\r\n  \"menuType\" : [ \"C\" ],\r\n  \"menuName\" : [ \"项目管理\" ],\r\n  \"url\" : [ \"/club/project\" ],\r\n  \"target\" : [ \"menuItem\" ],\r\n  \"perms\" : [ \"\" ],\r\n  \"orderNum\" : [ \"10\" ],\r\n  \"icon\" : [ \"\" ],\r\n  \"visible\" : [ \"0\" ]\r\n}', 0, NULL, '2022-10-27 21:53:02', '2022-10-27');
INSERT INTO `sys_oper_log` VALUES (232, '菜单管理', 1, 'com.study.web.controller.system.SysMenuController.addSave()', 1, 'admin', 1, 0, '健身俱乐部', '/gym/system/menu/add', '127.0.0.1', NULL, '{\r\n  \"parentId\" : [ \"2292\" ],\r\n  \"menuTopId\" : [ \"2\" ],\r\n  \"menuType\" : [ \"C\" ],\r\n  \"menuName\" : [ \"器械管理\" ],\r\n  \"url\" : [ \"/club/machine\" ],\r\n  \"target\" : [ \"menuItem\" ],\r\n  \"perms\" : [ \"\" ],\r\n  \"orderNum\" : [ \"20\" ],\r\n  \"icon\" : [ \"\" ],\r\n  \"visible\" : [ \"0\" ]\r\n}', 0, NULL, '2022-10-27 21:53:28', '2022-10-27');
INSERT INTO `sys_oper_log` VALUES (233, '字典类型', 1, 'com.study.web.controller.system.SysDictTypeController.addSave()', 1, 'admin', 1, 0, '健身俱乐部', '/gym/system/dict/add', '127.0.0.1', NULL, '{\r\n  \"dictName\" : [ \"器械进出类型\" ],\r\n  \"dictType\" : [ \"iotype\" ],\r\n  \"dictSort\" : [ \"1000\" ],\r\n  \"status\" : [ \"0\" ],\r\n  \"remark\" : [ \"\" ]\r\n}', 0, NULL, '2022-10-27 22:12:05', '2022-10-27');
INSERT INTO `sys_oper_log` VALUES (234, '字典数据', 1, 'com.study.web.controller.system.SysDictDataController.addSave()', 1, 'admin', 1, 0, '健身俱乐部', '/gym/system/dict/data/add', '127.0.0.1', NULL, '{\r\n  \"dictLabel\" : [ \"采购入库\" ],\r\n  \"dictValue\" : [ \"采购入库\" ],\r\n  \"dictType\" : [ \"iotype\" ],\r\n  \"cssClass\" : [ \"\" ],\r\n  \"dictSort\" : [ \"100\" ],\r\n  \"listClass\" : [ \"\" ],\r\n  \"isDefault\" : [ \"Y\" ],\r\n  \"status\" : [ \"0\" ],\r\n  \"remark\" : [ \"\" ]\r\n}', 0, NULL, '2022-10-27 22:12:22', '2022-10-27');
INSERT INTO `sys_oper_log` VALUES (235, '字典数据', 1, 'com.study.web.controller.system.SysDictDataController.addSave()', 1, 'admin', 1, 0, '健身俱乐部', '/gym/system/dict/data/add', '127.0.0.1', NULL, '{\r\n  \"dictLabel\" : [ \"报废销毁\" ],\r\n  \"dictValue\" : [ \"报废销毁\" ],\r\n  \"dictType\" : [ \"iotype\" ],\r\n  \"cssClass\" : [ \"\" ],\r\n  \"dictSort\" : [ \"90\" ],\r\n  \"listClass\" : [ \"\" ],\r\n  \"isDefault\" : [ \"Y\" ],\r\n  \"status\" : [ \"0\" ],\r\n  \"remark\" : [ \"\" ]\r\n}', 0, NULL, '2022-10-27 22:12:41', '2022-10-27');
INSERT INTO `sys_oper_log` VALUES (236, '字典类型', 1, 'com.study.web.controller.system.SysDictTypeController.addSave()', 1, 'admin', 1, 0, '健身俱乐部', '/gym/system/dict/add', '127.0.0.1', NULL, '{\r\n  \"dictName\" : [ \"运动疾病\" ],\r\n  \"dictType\" : [ \"diseaseList\" ],\r\n  \"dictSort\" : [ \"900\" ],\r\n  \"status\" : [ \"0\" ],\r\n  \"remark\" : [ \"\" ]\r\n}', 0, NULL, '2022-10-27 22:20:45', '2022-10-27');
INSERT INTO `sys_oper_log` VALUES (237, '字典数据', 1, 'com.study.web.controller.system.SysDictDataController.addSave()', 1, 'admin', 1, 0, '健身俱乐部', '/gym/system/dict/data/add', '127.0.0.1', NULL, '{\r\n  \"dictLabel\" : [ \"心脏病\" ],\r\n  \"dictValue\" : [ \"心脏病\" ],\r\n  \"dictType\" : [ \"diseaseList\" ],\r\n  \"cssClass\" : [ \"\" ],\r\n  \"dictSort\" : [ \"90\" ],\r\n  \"listClass\" : [ \"\" ],\r\n  \"isDefault\" : [ \"Y\" ],\r\n  \"status\" : [ \"0\" ],\r\n  \"remark\" : [ \"\" ]\r\n}', 0, NULL, '2022-10-27 22:20:59', '2022-10-27');
INSERT INTO `sys_oper_log` VALUES (238, '字典数据', 1, 'com.study.web.controller.system.SysDictDataController.addSave()', 1, 'admin', 1, 0, '健身俱乐部', '/gym/system/dict/data/add', '127.0.0.1', NULL, '{\r\n  \"dictLabel\" : [ \"高血压\" ],\r\n  \"dictValue\" : [ \"高血压\" ],\r\n  \"dictType\" : [ \"diseaseList\" ],\r\n  \"cssClass\" : [ \"\" ],\r\n  \"dictSort\" : [ \"80\" ],\r\n  \"listClass\" : [ \"\" ],\r\n  \"isDefault\" : [ \"Y\" ],\r\n  \"status\" : [ \"0\" ],\r\n  \"remark\" : [ \"\" ]\r\n}', 0, NULL, '2022-10-27 22:21:07', '2022-10-27');
INSERT INTO `sys_oper_log` VALUES (239, '字典数据', 1, 'com.study.web.controller.system.SysDictDataController.addSave()', 1, 'admin', 1, 0, '健身俱乐部', '/gym/system/dict/data/add', '127.0.0.1', NULL, '{\r\n  \"dictLabel\" : [ \"呼吸系统\" ],\r\n  \"dictValue\" : [ \"呼吸系统\" ],\r\n  \"dictType\" : [ \"diseaseList\" ],\r\n  \"cssClass\" : [ \"\" ],\r\n  \"dictSort\" : [ \"80\" ],\r\n  \"listClass\" : [ \"\" ],\r\n  \"isDefault\" : [ \"Y\" ],\r\n  \"status\" : [ \"0\" ],\r\n  \"remark\" : [ \"\" ]\r\n}', 0, NULL, '2022-10-27 22:21:29', '2022-10-27');
INSERT INTO `sys_oper_log` VALUES (240, '字典数据', 1, 'com.study.web.controller.system.SysDictDataController.addSave()', 1, 'admin', 1, 0, '健身俱乐部', '/gym/system/dict/data/add', '127.0.0.1', NULL, '{\r\n  \"dictLabel\" : [ \"肝肾系统\" ],\r\n  \"dictValue\" : [ \"肝肾系统\" ],\r\n  \"dictType\" : [ \"diseaseList\" ],\r\n  \"cssClass\" : [ \"\" ],\r\n  \"dictSort\" : [ \"70\" ],\r\n  \"listClass\" : [ \"\" ],\r\n  \"isDefault\" : [ \"Y\" ],\r\n  \"status\" : [ \"0\" ],\r\n  \"remark\" : [ \"\" ]\r\n}', 0, NULL, '2022-10-27 22:21:40', '2022-10-27');
INSERT INTO `sys_oper_log` VALUES (241, '字典数据', 1, 'com.study.web.controller.system.SysDictDataController.addSave()', 1, 'admin', 1, 0, '健身俱乐部', '/gym/system/dict/data/add', '127.0.0.1', NULL, '{\r\n  \"dictLabel\" : [ \"脚踝\" ],\r\n  \"dictValue\" : [ \"脚踝\" ],\r\n  \"dictType\" : [ \"diseaseList\" ],\r\n  \"cssClass\" : [ \"\" ],\r\n  \"dictSort\" : [ \"60\" ],\r\n  \"listClass\" : [ \"\" ],\r\n  \"isDefault\" : [ \"Y\" ],\r\n  \"status\" : [ \"0\" ],\r\n  \"remark\" : [ \"\" ]\r\n}', 0, NULL, '2022-10-27 22:21:51', '2022-10-27');
INSERT INTO `sys_oper_log` VALUES (242, '字典数据', 1, 'com.study.web.controller.system.SysDictDataController.addSave()', 1, 'admin', 1, 0, '健身俱乐部', '/gym/system/dict/data/add', '127.0.0.1', NULL, '{\r\n  \"dictLabel\" : [ \"膝盖\" ],\r\n  \"dictValue\" : [ \"膝盖\" ],\r\n  \"dictType\" : [ \"diseaseList\" ],\r\n  \"cssClass\" : [ \"\" ],\r\n  \"dictSort\" : [ \"60\" ],\r\n  \"listClass\" : [ \"\" ],\r\n  \"isDefault\" : [ \"Y\" ],\r\n  \"status\" : [ \"0\" ],\r\n  \"remark\" : [ \"\" ]\r\n}', 0, NULL, '2022-10-27 22:22:02', '2022-10-27');
INSERT INTO `sys_oper_log` VALUES (243, '参数管理', 3, 'com.study.web.controller.system.SysConfigController.remove()', 1, 'admin', 1, 0, '健身俱乐部', '/gym/system/config/remove', '127.0.0.1', NULL, '{\r\n  \"ids\" : [ \"118,119,120\" ]\r\n}', 0, NULL, '2022-10-27 22:24:18', '2022-10-27');
INSERT INTO `sys_oper_log` VALUES (244, '字典类型', 3, 'com.study.web.controller.system.SysDictTypeController.remove()', 1, 'admin', 1, 0, '健身俱乐部', '/gym/system/dict/remove', '127.0.0.1', NULL, '{\r\n  \"ids\" : [ \"3,4,5\" ]\r\n}', 1, '系统开关已分配,不能删除', '2022-10-27 22:24:34', '2022-10-27');
INSERT INTO `sys_oper_log` VALUES (245, '字典类型', 3, 'com.study.web.controller.system.SysDictTypeController.remove()', 1, 'admin', 1, 0, '健身俱乐部', '/gym/system/dict/remove', '127.0.0.1', NULL, '{\r\n  \"ids\" : [ \"4,5\" ]\r\n}', 1, '任务状态已分配,不能删除', '2022-10-27 22:24:40', '2022-10-27');
INSERT INTO `sys_oper_log` VALUES (246, '角色管理', 1, 'com.study.web.controller.system.SysRoleController.addSave()', 1, 'admin', 1, 0, '健身俱乐部', '/gym/system/role/add', '127.0.0.1', NULL, '{\r\n  \"roleName\" : [ \"教练\" ],\r\n  \"roleKey\" : [ \"coach\" ],\r\n  \"roleSort\" : [ \"100\" ],\r\n  \"status\" : [ \"0\" ],\r\n  \"remark\" : [ \"\" ],\r\n  \"menuIds\" : [ \"\" ]\r\n}', 0, NULL, '2022-10-29 22:30:29', '2022-10-29');
INSERT INTO `sys_oper_log` VALUES (247, '部门管理', 1, 'com.study.web.controller.system.SysDeptController.addSave()', 1, 'admin', 1, 0, '健身俱乐部', '/gym/system/dept/add', '127.0.0.1', NULL, '{\r\n  \"parentId\" : [ \"100\" ],\r\n  \"deptName\" : [ \"教练部\" ],\r\n  \"shortName\" : [ \"教练部\" ],\r\n  \"orderNum\" : [ \"100\" ],\r\n  \"leader\" : [ \"\" ],\r\n  \"phone\" : [ \"\" ],\r\n  \"email\" : [ \"\" ],\r\n  \"status\" : [ \"0\" ]\r\n}', 0, NULL, '2022-10-29 22:30:48', '2022-10-29');
INSERT INTO `sys_oper_log` VALUES (248, '菜单管理', 1, 'com.study.web.controller.system.SysMenuController.addSave()', 1, 'admin', 1, 0, '健身俱乐部', '/gym/system/menu/add', '127.0.0.1', NULL, '{\r\n  \"parentId\" : [ \"2292\" ],\r\n  \"menuTopId\" : [ \"2\" ],\r\n  \"menuType\" : [ \"C\" ],\r\n  \"menuName\" : [ \"教练管理\" ],\r\n  \"url\" : [ \"/club/coach\" ],\r\n  \"target\" : [ \"menuItem\" ],\r\n  \"perms\" : [ \"\" ],\r\n  \"orderNum\" : [ \"30\" ],\r\n  \"icon\" : [ \"\" ],\r\n  \"visible\" : [ \"0\" ]\r\n}', 0, NULL, '2022-10-29 22:35:22', '2022-10-29');
INSERT INTO `sys_oper_log` VALUES (249, '菜单管理', 2, 'com.study.web.controller.system.SysMenuController.editSave()', 1, 'admin', 1, 0, '健身俱乐部', '/gym/system/menu/edit', '127.0.0.1', NULL, '{\r\n  \"menuId\" : [ \"2292\" ],\r\n  \"parentId\" : [ \"0\" ],\r\n  \"menuTopId\" : [ \"2\" ],\r\n  \"menuType\" : [ \"M\" ],\r\n  \"menuName\" : [ \"俱乐部管理\" ],\r\n  \"url\" : [ \"#\" ],\r\n  \"target\" : [ \"menuItem\" ],\r\n  \"perms\" : [ \"\" ],\r\n  \"orderNum\" : [ \"100\" ],\r\n  \"icon\" : [ \"fa fa-file-word-o\" ],\r\n  \"visible\" : [ \"0\" ]\r\n}', 0, NULL, '2022-10-29 23:15:55', '2022-10-29');
INSERT INTO `sys_oper_log` VALUES (250, '菜单管理', 1, 'com.study.web.controller.system.SysMenuController.addSave()', 1, 'admin', 1, 0, '健身俱乐部', '/gym/system/menu/add', '127.0.0.1', NULL, '{\r\n  \"parentId\" : [ \"0\" ],\r\n  \"menuTopId\" : [ \"2\" ],\r\n  \"menuType\" : [ \"M\" ],\r\n  \"menuName\" : [ \"论坛管理\" ],\r\n  \"url\" : [ \"\" ],\r\n  \"target\" : [ \"menuItem\" ],\r\n  \"perms\" : [ \"\" ],\r\n  \"orderNum\" : [ \"20\" ],\r\n  \"icon\" : [ \"fa fa-circle-thin\" ],\r\n  \"visible\" : [ \"0\" ]\r\n}', 0, NULL, '2022-10-29 23:16:26', '2022-10-29');
INSERT INTO `sys_oper_log` VALUES (251, '菜单管理', 2, 'com.study.web.controller.system.SysMenuController.editSave()', 1, 'admin', 1, 0, '健身俱乐部', '/gym/system/menu/edit', '127.0.0.1', NULL, '{\r\n  \"menuId\" : [ \"2298\" ],\r\n  \"parentId\" : [ \"0\" ],\r\n  \"menuTopId\" : [ \"2\" ],\r\n  \"menuType\" : [ \"M\" ],\r\n  \"menuName\" : [ \"论坛管理\" ],\r\n  \"url\" : [ \"#\" ],\r\n  \"target\" : [ \"menuItem\" ],\r\n  \"perms\" : [ \"\" ],\r\n  \"orderNum\" : [ \"80\" ],\r\n  \"icon\" : [ \"fa fa-circle-thin\" ],\r\n  \"visible\" : [ \"0\" ]\r\n}', 0, NULL, '2022-10-29 23:16:35', '2022-10-29');
INSERT INTO `sys_oper_log` VALUES (252, '菜单管理', 1, 'com.study.web.controller.system.SysMenuController.addSave()', 1, 'admin', 1, 0, '健身俱乐部', '/gym/system/menu/add', '127.0.0.1', NULL, '{\r\n  \"parentId\" : [ \"2298\" ],\r\n  \"menuTopId\" : [ \"2\" ],\r\n  \"menuType\" : [ \"C\" ],\r\n  \"menuName\" : [ \"版块管理\" ],\r\n  \"url\" : [ \"/bbs/section\" ],\r\n  \"target\" : [ \"menuItem\" ],\r\n  \"perms\" : [ \"\" ],\r\n  \"orderNum\" : [ \"100\" ],\r\n  \"icon\" : [ \"\" ],\r\n  \"visible\" : [ \"0\" ]\r\n}', 0, NULL, '2022-10-29 23:16:56', '2022-10-29');
INSERT INTO `sys_oper_log` VALUES (253, '个人信息', 2, 'com.study.web.controller.system.SysProfileController.updateAvatar()', 1, 'admin', 1, 0, '健身俱乐部', '/gym/system/user/profile/updateAvatar', '127.0.0.1', NULL, '{ }', 0, NULL, '2022-10-30 11:46:37', '2022-10-30');
INSERT INTO `sys_oper_log` VALUES (254, '参数管理', 2, 'com.study.web.controller.system.SysConfigController.editSave()', 1, 'admin', 1, 0, '健身俱乐部', '/gym/system/config/edit', '127.0.0.1', NULL, '{\r\n  \"configId\" : [ \"101\" ],\r\n  \"configName\" : [ \"系统名称\" ],\r\n  \"configKey\" : [ \"sys.name\" ],\r\n  \"configValue\" : [ \"健身俱乐部\" ]\r\n}', 0, NULL, '2022-10-30 15:10:01', '2022-10-30');
INSERT INTO `sys_oper_log` VALUES (255, '菜单管理', 1, 'com.study.web.controller.system.SysMenuController.addSave()', 1, 'admin', 1, 0, '健身俱乐部', '/gym/system/menu/add', '127.0.0.1', NULL, '{\r\n  \"parentId\" : [ \"2292\" ],\r\n  \"menuTopId\" : [ \"2\" ],\r\n  \"menuType\" : [ \"C\" ],\r\n  \"menuName\" : [ \"运动消费记录\" ],\r\n  \"url\" : [ \"/club/record\" ],\r\n  \"target\" : [ \"menuItem\" ],\r\n  \"perms\" : [ \"\" ],\r\n  \"orderNum\" : [ \"50\" ],\r\n  \"icon\" : [ \"\" ],\r\n  \"visible\" : [ \"0\" ]\r\n}', 0, NULL, '2022-10-30 23:21:40', '2022-10-30');
INSERT INTO `sys_oper_log` VALUES (256, '个人信息', 2, 'com.study.web.controller.system.SysProfileController.updateAvatar()', 1, 'admin', 1, 0, '健身俱乐部', '/gym/system/user/profile/updateAvatar', '127.0.0.1', NULL, '{ }', 0, NULL, '2022-09-04 20:55:41', '2022-09-04');
INSERT INTO `sys_oper_log` VALUES (257, '个人信息', 2, 'com.study.web.controller.system.SysProfileController.update()', 1, 'admin', 1, 0, '健身俱乐部', '/gym/system/user/profile/update', '127.0.0.1', NULL, '{\r\n  \"id\" : [ \"\" ],\r\n  \"userName\" : [ \"超级管理员\" ],\r\n  \"phonenumber\" : [ \"17755895101\" ],\r\n  \"email\" : [ \"\" ],\r\n  \"sex\" : [ \"1\" ]\r\n}', 0, NULL, '2022-09-04 20:55:45', '2022-09-04');
...
-- Records of sys_post
-- ----------------------------
INSERT INTO `sys_post` VALUES (1, 'gly', '管理员', 1, '0', 'admin', '2018-03-16 11:33:00', 'admin', '2022-04-12 21:41:27', '', NULL, NULL, 0);
INSERT INTO `sys_post` VALUES (2, 'hqgl', '后勤管理', 2, '0', 'admin', '2018-03-16 11:33:00', 'admin', '2022-10-24 11:56:31', '俱乐部内部人员，资产，财务等管理', NULL, NULL, 0);
INSERT INTO `sys_post` VALUES (3, 'xlgl', '训练管理', 3, '0', 'admin', '2018-03-16 11:33:00', 'admin', '2022-10-24 11:55:43', '项目训练', NULL, NULL, 0);
INSERT INTO `sys_post` VALUES (4, 'sbgl', '设备管理', 30, '0', 'admin', '2018-03-16 11:33:00', 'admin', '2022-10-24 11:55:23', '训练器材的日常维护保养', NULL, NULL, 0);
INSERT INTO `sys_post` VALUES (5, 'hygl', '会员管理', 5, '0', 'admin', '2022-04-13 21:40:48', 'admin', '2022-10-24 11:54:47', '职责是办理会员卡相关业务', NULL, NULL, 0);
...
) ENGINE = InnoDB AUTO_INCREMENT = 120 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '角色信息表' ROW_FORMAT = Compact;

-- ----------------------------
-- Records of sys_role
-- ----------------------------
INSERT INTO `sys_role` VALUES (1, '超级管理员', 'admin', 1, '1', '0', 0, 'admin', '2018-03-16 11:33:00', 'admin', '2020-11-05 14:37:13', '管理员', NULL, NULL);
INSERT INTO `sys_role` VALUES (116, '工作人员', 'gzry', 90, '1', '0', 0, 'admin', '2022-10-24 14:21:43', 'admin', '2022-10-31 12:52:39', '', NULL, NULL);
INSERT INTO `sys_role` VALUES (117, '会员', 'hy', 80, '1', '0', 0, 'admin', '2022-10-24 14:22:02', 'admin', '2022-10-31 12:52:46', '', NULL, NULL);
INSERT INTO `sys_role` VALUES (118, '教练', 'coach', 100, '1', '0', 0, 'admin', '2022-10-29 22:30:28', '', NULL, NULL, NULL, NULL);
INSERT INTO `sys_role` VALUES (119, '版主', 'banzhu', 111, '1', '0', 0, '', NULL, '', NULL, NULL, NULL, NULL);
...
INSERT INTO `sys_role_menu` VALUES (116, 2005);
INSERT INTO `sys_role_menu` VALUES (116, 2287);
INSERT INTO `sys_role_menu` VALUES (116, 2288);
INSERT INTO `sys_role_menu` VALUES (116, 2289);
INSERT INTO `sys_role_menu` VALUES (116, 2290);
INSERT INTO `sys_role_menu` VALUES (116, 2291);
INSERT INTO `sys_role_menu` VALUES (116, 2292);
INSERT INTO `sys_role_menu` VALUES (116, 2293);
INSERT INTO `sys_role_menu` VALUES (116, 2294);
INSERT INTO `sys_role_menu` VALUES (116, 2295);
INSERT INTO `sys_role_menu` VALUES (116, 2296);
INSERT INTO `sys_role_menu` VALUES (116, 2297);
INSERT INTO `sys_role_menu` VALUES (116, 2298);
INSERT INTO `sys_role_menu` VALUES (116, 2299);
INSERT INTO `sys_role_menu` VALUES (116, 2300);
INSERT INTO `sys_role_menu` VALUES (116, 2301);
INSERT INTO `sys_role_menu` VALUES (116, 2302);
INSERT INTO `sys_role_menu` VALUES (116, 2303);
INSERT INTO `sys_role_menu` VALUES (116, 2304);
INSERT INTO `sys_role_menu` VALUES (116, 2305);
INSERT INTO `sys_role_menu` VALUES (116, 2306);
INSERT INTO `sys_role_menu` VALUES (116, 2307);
INSERT INTO `sys_role_menu` VALUES (116, 2308);
INSERT INTO `sys_role_menu` VALUES (117, 2292);
INSERT INTO `sys_role_menu` VALUES (117, 2300);
INSERT INTO `sys_role_menu` VALUES (117, 2307);
INSERT INTO `sys_role_menu` VALUES (117, 2309);
...
) ENGINE = InnoDB AUTO_INCREMENT = 12715 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '用户信息表' ROW_FORMAT = Compact;

-- ----------------------------
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES (1, 100, 'admin', '超级管理员', '0001', '0001', '', '17755895101', '1', '/profile/avatar/2022/09/04/da8d7a860ed8b8fb1cc586609a29e5ee.png', 'd1cdf661140a87c33fa798c452612c34', '5c3753', '0', 0, '', '2019-08-06 23:43:50', '127.0.0.1', '2022-09-04 22:16:09', '管理员', 'admin', '2018-03-16 11:33:00', 'admin', '2022-09-04 22:16:08', NULL, NULL, 0, 'wU6G3AbTqzby88fFF69W1w==', NULL, NULL, NULL);
INSERT INTO `sys_user` VALUES (12711, 216, 'zhangsan', '张三', NULL, NULL, '', '17755895102', '0', '/profile/avatar/2022/09/04/18f88b9ac387603edbe4fd4a1d9e069d.png', 'b62c1ffb5a13fabe5e89ed548c62e1ef', 'bd2fa2', '0', 1, NULL, '2022-10-24 15:52:01', '127.0.0.1', '2022-09-04 22:14:10', '是的方法', 'admin', '2022-10-24 15:52:01', 'admin', '2022-09-04 22:14:10', NULL, NULL, 0, 'VZWi0qKgVDf2SFCjUUkEyp6UEDWcya2+r1AdqKUNvMA9npZn/dzmVdSPMjWV1fQ1', '2000-09-05', NULL, '呼吸系统');
INSERT INTO `sys_user` VALUES (12712, 217, 'jiaolian1', '吴教练', NULL, NULL, 'wuxiangt@163.com', '17755895103', '0', '/profile/upload/2022/09/04/147a43174f96f00f594f46966c3a1c5c.jpg', '76895fb0f8d5e529783e096ef0d4794a', 'b9c619', '0', 2, NULL, '2022-10-29 22:35:56', '127.0.0.1', '2022-09-04 21:15:41', '一个美女教练哦', 'admin', '2022-10-29 22:35:56', 'admin', '2022-09-04 21:21:36', NULL, NULL, 0, 'Pr44sMDE7FGpKKBQAbCJt+s1JrRnplDjXeFNXGtsHqI9npZn/dzmVdSPMjWV1fQ1', NULL, 32, NULL);
INSERT INTO `sys_user` VALUES (12713, 216, 'lisi', '李四', NULL, NULL, '', '17755895106', '0', '', '686a231d4857dcaf56d32f15ad6bf395', '3366ca', '0', 1, NULL, '2022-10-31 01:16:08', '127.0.0.1', '2022-09-04 22:06:27', '手动阀手动阀', 'admin', '2022-10-31 01:16:08', 'admin', '2022-09-04 22:06:27', NULL, NULL, 0, 'nZArabVlKt/ZXvkfUZffEMw93zqvdzx8Qgc/tjJFeqY9npZn/dzmVdSPMjWV1fQ1', '2022-09-15', NULL, '高血压,呼吸系统');
INSERT INTO `sys_user` VALUES (12714, 217, 'jianlian2', '王教练', NULL, NULL, 'wangxiaot@163.com', '13529108342', '2', '/profile/upload/2022/09/04/d703a41c5624fe037c116d2c5f26983c.jpg', '64c3918ffee022c7ddb34d89383c1e0c', '34da2c', '0', 2, NULL, '2022-09-04 21:21:05', '', NULL, '负责的教练一个', 'admin', '2022-09-04 21:21:05', '', NULL, NULL, NULL, 0, 'gsISmFtJXTYuroZBEJOaAQZp4g4IhE/axS6awU5KiABiDrIGx0X4qkmKzrBcfuNR', NULL, 35, NULL);
...
-- ----------------------------
INSERT INTO `sys_user_online` VALUES ('066bce9f-3149-45fd-984e-0bdc083da26a', 'admin', '超级管理员', '0001', '0001', 0, '13866725169', '健身俱乐部', '127.0.0.1', '内网IP', 'Chrome 9', 'Windows 10', 'on_line', '2022-10-30 10:49:45', '2022-10-30 15:07:38', 604800000);
INSERT INTO `sys_user_online` VALUES ('508a4218-b49b-4503-96f2-92f151b0414a', 'admin', '超级管理员', '0001', '0001', 0, '13866725169', '健身俱乐部', '127.0.0.1', '内网IP', 'Chrome 9', 'Windows 10', 'on_line', '2022-10-27 21:52:33', '2022-10-27 22:32:39', 604800000);
INSERT INTO `sys_user_online` VALUES ('849bf2b2-fffa-40ac-87d3-68d1ca785a82', 'admin', '超级管理员', '0001', '0001', 0, '17755895101', '健身俱乐部', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', 'on_line', '2022-09-04 21:15:34', '2022-09-04 22:16:09', 604800000);
INSERT INTO `sys_user_online` VALUES ('a4d4e426-63a5-49d4-9f77-8fe4d58ed8f2', 'admin', '超级管理员', '0001', '0001', 0, '13866725169', '健身俱乐部', '127.0.0.1', '内网IP', 'Chrome 9', 'Windows 10', 'on_line', '2022-10-29 22:30:08', '2022-10-29 23:15:34', 604800000);
INSERT INTO `sys_user_online` VALUES ('ac80dced-8a35-4eb3-b54c-516544fa8259', 'admin', '超级管理员', '0001', '0001', 0, '13866725169', '健身俱乐部', '127.0.0.1', '内网IP', 'Chrome 9', 'Windows 10', 'on_line', '2022-10-24 16:58:11', '2022-10-24 17:05:36', 604800000);
INSERT INTO `sys_user_online` VALUES ('d04443d2-1125-4ced-8250-a09a89c5d281', 'admin', '超级管理员', '0001', '0001', 0, '17755895101', '健身俱乐部', '127.0.0.1', '内网IP', 'Chrome 9', 'Windows 10', 'on_line', '2022-10-31 12:58:11', '2022-10-31 13:14:58', 604800000);
INSERT INTO `sys_user_online` VALUES ('d83acf2d-5c9f-42f1-9e54-e224ddeda44f', 'zhangsan', '张三', NULL, NULL, 1, '17755895102', '会员', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', 'on_line', '2022-09-04 22:14:05', '2022-09-04 22:14:10', 604800000);
INSERT INTO `sys_user_online` VALUES ('ebfc415a-3f97-4f59-bcaf-7c37b0310816', 'zhangsan', '张三', NULL, NULL, 1, '17755895106', '会员', '127.0.0.1', '内网IP', 'Chrome 9', 'Windows 10', 'on_line', '2022-10-31 01:20:00', '2022-10-31 01:20:12', 604800000);
INSERT INTO `sys_user_online` VALUES ('fd84f645-c198-48f5-a80b-8693bd1abfc7', 'admin', '超级管理员', '0001', '0001', 0, '13866725169', '健身俱乐部', '127.0.0.1', '内网IP', 'Chrome 9', 'Windows 10', 'on_line', '2022-10-26 23:14:36', '2022-10-26 23:24:30', 604800000);
...
INSERT INTO `sys_user_role` VALUES (12712, 118);
INSERT INTO `sys_user_role` VALUES (12713, 117);
INSERT INTO `sys_user_role` VALUES (12714, 118);
